...
//#define GIA_DEBUG_DISABLE_3i_CODE
	...
	//#endif
		...
		//#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE	//not yet defined
			...
			//#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR	//requirement
			...
			//#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED	//not yet defined
				...
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY	//GIA3h2a	//assume cannot backprop through parseTreeGroupNeuralNet
					...
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_WEAK1	//requires previousParseComponent->parseTreeGroupRef
					//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_WEAK2	//store component's->parseTreeGroupRef for 1 layer
					//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_WEAK3	//can backprop through groupNeuralNet but not parseTreeGroupNeuralNet
					#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_WEAK0
						#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY_WEAK	//GIA3h2a		//not properly bio compatible (strict bio can't backprop/get info from lower level neurons) - when removing lastest component; recalculate parent parseTreeTotalWeight based on parseTreeGroup latestComponent->parseTreeGroupRef parseTreeTotalWeight value
					#endif
					#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_WEAK1
						#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT_MUTUALLY_EXCLUSIVE_BIO	//GIA3i1a
					#endif
					//not yet coded;
					//#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_WEAK2
					//	#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY_WEAK2	 //not properly bio compatible (can't backprop/get info from lower level neurons) - when removing lastest component; recalculate parent parseTreeMaxWeight/parseTreeMinWeight based on all parseTreeGroup component's->parseTreeGroupRef parseTreeMaxWeight/parseTreeMinWeight values
					//#endif
					...
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE_PERFORMANCE_BIO	//GIA3i1a
						...
						#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_WEAK0	//ie GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY_WEAK
							#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_WEAK1
					...
					#endif
					#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_BIO_WEAK3
		...
		//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_HEAVY	//GIA3g6-9
			...
			//light: only ever maintain a single instance of the neural network in memory
				...
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED		//GIA3g11a
					...
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_RESET_COMPONENT_NEURONCOMPONENTCONNECTIONACTIVEWORDRECORD	//GIA3g11aTEMP46

					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_REMOVE_LAST_OPTIONAL_COMPONENTS	//mandatory

					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_REVERSE	//mandatory //required to support recursion (parse sentences from right to left); eg (Tom said that (Mary said))
					...
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_REVERSE	//required to support recursion (parse sentences from right to left); eg (Tom said that (Mary said))
