...
//#define GIA_DEBUG_DISABLE_3j_CODE
	...
	//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR	//GIA3j2a
		...
		//#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//not yet defined
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_FORCE_RESET_IF_NO_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//GIA3j2bTEMP19	//mandatory
			...
			//#define GIA_POS_REL_TRANSLATOR_SANI_HEAVY	//GIA3g6-9
				...
				//light: only ever maintain a single instance of the neural network in memory
					...
					#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED		//GIA3g11a
						...
						#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS	//mandatory
