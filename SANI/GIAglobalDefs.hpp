...
//#define GIA_DEBUG_DISABLE_3g_CODE
	...
	#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK	//3g1a
		...
		//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_HEAVY	//3g9x
			...
			//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_HEAVY_UNOPTIMISED
				...
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_HEAVY_OPTIMISED
			...
			//light: only ever maintain a single instance of the neural network in memory
				...
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_REMOVE_LAST_OPTIONAL_COMPONENTS
