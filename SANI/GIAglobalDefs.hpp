...
//#define GIA_DEBUG_DISABLE_3g_CODE
	...
	#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK	//3g1a
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_RESTRICT_GROUP_ACTIVATION_TO_SINGLE_COMPONENT_PER_WORD	//3g1n	// restrict the group component activation to a single component per word being parsed
