...
//#define GIA_DEBUG_DISABLE_3g_CODE
	...
	#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK	//3g1a
		...
		//#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENFORCE_WORD_CONNECTIVITY	//not yet defined
			//#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SAVE_PARSE_TREE	//not yet defined
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SAVE_PARSE_TREE_TRIAL	//3g5aTEMP45
			//#endif
		//#endif

		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENSURE_LATER_COMPONENTS_DO_NOT_CONTAIN_WORD_REFERENCES_FROM_EARLIER_COMPONENTS	//3g5aTEMP38
			...
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENSURE_LATER_COMPONENTS_DO_NOT_CONTAIN_WORD_REFERENCES_FROM_EARLIER_COMPONENTS_REVERSE
				...
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SAVE_PARSE_TREE_REVERSE_REFERENCES
			#endif
			//#define GIA_DEBUG_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENSURE_LATER_COMPONENTS_DO_NOT_CONTAIN_WORD_REFERENCES_FROM_EARLIER_COMPONENTS
		#endif
		
		//#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SAVE_PARSE_TREE	//not yet defined
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ACTIVATION_STACK	//3g5aTEMP36
			#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ACTIVATION_STACK
			#endif
		//#endif
		
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_TEMPORARY_WORKAROUND_TAKE_POS_PERMUTATION_CORRESPONDING_TO_SUCCESSFUL_PARSE_TREE	//3g5aTEMP33
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_TEMPORARY_WORKAROUND_TAKE_POS_PERMUTATION_CORRESPONDING_TO_FIRST_SUCCESSFUL_PARSE_TREE	//made explicit @3g5aTEMP35 - in the future, must prioritise the pos permutations that are most common (requires statistical database of POS combinations), ensuring that they result in a successful parse tree
		
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LAYER_START (1)
		
		#define GIA_DEBUG_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PROPAGATE_EXTRA6	//print currentParseTreeGroup tree upon activating a group
		...
		//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_RESTRICT_GROUP_ACTIVATION_TO_SINGLE_COMPONENT_PER_WORD	//3g1n	// restrict the group component activation to a single component per word being parsed	//CHECKTHIS: depreciated @3g5aTEMP31
		
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY	//tested 3g1e
			...
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENFORCE_WORD_CONNECTIVITY	//3g1e - emulates GIA_TXT_REL_TRANSLATOR_INVERSE_NEURAL_NETWORK: reject all activation paths that do not connect to a previous word in sentence			//for every possible activation path for a word, select the one which connects to the group containing the most recent activated component
				//note this feature is required because it needs to reject connection to more weakly activated neurons in favour of more strongly activated neurons (this feature therefore simulates the firing preference of more recently activated neurons)
				...
				#endif
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENFORCE_WORD_CONNECTIVITY_TEST_FULL_PARSE_TREES	//3g5aTEMP52
			#endif
		#endif
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS	//GIA3g1aTEMP49
		#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS
			//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_TREAT_OR_AS_FUZZY	//disabled GIA3g1aTEMP54
			//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SOLIDIFY_NET_BACKPROP_
		#endif
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREVENT_CIRCULAR_CONNECTION_LOOPS	//3g1a	//temporarily enabled until determined due to parse these
	...
	#define GIA_PREPROCESSOR_WORD_NOUN_VARIANTS_PRIORITISE_IRREGULAR_PLURAL_FORM	//3f5a 
		...
		#define GIA_TXT_REL_TRANSLATOR_RULES		
			...
			#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_RESTRICT_RECURSION	//mandatory
				...
				#ifdef GIA_TXT_REL_TRANSLATOR_RULES_LOGIC_REFERENCES
					#define GIA_TXT_REL_TRANSLATOR_GROUP_TYPE_MAX_NUMBER_CONSECUTIVE_LAYERS_LOGIC_REFERENCES (7)
				#endif
			#endif
