...
//#define GIA_DEBUG_DISABLE_3k_CODE
	...
	#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR	//GIA3j2a
		...
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_SINGLE_POS_PERMUTATION
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_MAX_POS_PERMUTATIONS
		...
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_BASIC
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_BASIC
			#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES		
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_BASIC_VERY
		#endif
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TRACE
...
//#define GIA_DEBUG_DISABLE_3j_CODE
	...
	//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR	//GIA3j2a
		...
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_MAX_POS_PERMUTATIONS
			...
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_MAX_POS_PERMUTATIONS_NUM (20)
		#endif
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TEST_VERIFICATION_AFTER_GENERATION	//requires inputText to include a duplication of all sentences halfway through file
			
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG2
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG2
			#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TRACE
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_BASIC
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_WORDCONNECTIVITY_VERIFICATION
			...
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
		#endif
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG	//temp
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG
			#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TRACE
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_BASIC
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_WORDCONNECTIVITY_VERIFICATION
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_SPLIT
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_NEVER_SPLIT_GROUP_BETWEEN_TWO_IDENTICAL_COMPONENTS
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TEST_VERIFICATION_AFTER_GENERATION	//requires inputText to include a duplication of all sentences halfway through file
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TEST_VERIFICATION_PROPAGATION_IN_OPPOSITE_DIRECTION	//temp test only	//FAIL@GIA3j2aTEMP134, OK@GIA3j2j
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_SINGLE_POS_PERMUTATION
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_PRINT_GROUP_INDICES
			
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_WORDINDEX_VERIFICATION   //detailed debug
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA3  //detailed debug
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA4
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
		#endif
