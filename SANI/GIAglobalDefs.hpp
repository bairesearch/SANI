...
//#define GIA_DEBUG_DISABLE_3g_CODE
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK	//3g1a
			...
			//#ifdef GIA_TXT_REL_TRANSLATOR_RULES_CODE_GROUP_PREVIOUS_WORD_POS_TYPE //not yet defined
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREVIOUS_WORD_POS_TYPE_CHECKS	
			...
			#define GIA_TXT_REL_TRANSLATOR_RULES_DEFINE_GROUP_TYPE_BACKUP_AT_START	//required for GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK

			//#define GIA_DEBUG_TXT_REL_TRANSLATOR_NEURAL_NETWORK_CREATE
			#define GIA_DEBUG_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PROPAGATE
			
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREVENT_CIRCULAR_CONNECTION_LOOPS	//temporarily enabled until determined due to parse these
			
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ADD_ANN_LAYER_FOR_EVERY_GROUP_TYPE	//optional - not currently used
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_CREATE_NEURONS_FOR_NOUN_VERB_VARIANTS
		#endif
	#endif
#endif
