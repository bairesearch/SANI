...
//#define GIA_DEBUG_DISABLE_3g_CODE
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK	//3g1a
			...
			//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE	//3g1b
			#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE_BASIC	//temporary: modify and execute GIAtxtRelTranslatorParserClass::generateSemanticRelationsFromTxtRelations rather than adapting this code for GIAtxtRelTranslatorNeuralNetwork
				#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE_BASIC
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE_BASIC_ALL_ACTIVE_OR_SUBCOMPONENTS
				#endif
			#endif
			...
			#define GIA_TXT_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START	//GIA3g1aTEMP47
