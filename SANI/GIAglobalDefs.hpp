...
//#define GIA_DEBUG_DISABLE_3j_CODE
	...
	//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR	//3j2a	//verifies that  //more integrated alternative to ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK
		...
		#endif
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR_VERIFICATION	//not required	//can be disabled for initial debugging, but should be activated for software verification
		...
		//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_OPTIONAL_AND_MULTIPLE_INPUTS	//reduces complexity (size) of generated network, but increases algorithm complexity (CHECKTHIS)
			...
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR_COMPONENT_DETECT_CENTRAL_VARIATION
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR_COMPONENT_DETECT_EDGE_VARIATION
			//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR_COMPONENT_DETECT_CENTRAL_VARIATION_OLD
		#endif
		...
		//see GIAtxtRelTranslatorNeuralNetworkPropagateCompactClass::defineFirstLayer: GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_AS_WILDCARDS is not supported, GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_AS_NOUNS is required
				...
				//light: only ever maintain a single instance of the neural network in memory
					...
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED		//GIA3g11a
						...
						#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_REPLICATE_TOP_LEVEL_PARSE_TREE	//GIA3g11f - required for GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED
							...
							#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_LIGHT_OPTIMISED_FREE_MEMORY	//GIA3g11p
						#endif
