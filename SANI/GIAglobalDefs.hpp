...
#define GIA_POS_REL_TRANSLATOR	//GIA3	//requires GIA_PREPROCESSOR
	...
	#define GIA_POS_REL_TRANSLATOR_SANI	//GIA3g1a
		...
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR	//GIA3j2a
			...
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_LAST_COMPONENTS	//GIA3l7a (incomplete)
		#endif
	#endif
#endif
...
//#define GIA_DEBUG_DISABLE_3l_CODE
	...
	//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_TRACE
	#ifdef GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_TRACE
		#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE
		#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA3  //detailed debug
		#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA4
	#endif
	//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_BASIC2
	...
	//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS
		...
		#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS_NUM (2)		
		#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS_FOR_PARTICULAR_SENTENCE	//temp
		#ifdef GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS_FOR_PARTICULAR_SENTENCE
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS_FOR_PARTICULAR_SENTENCE_INDEX (2)
		#endif
	#endif

	//#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_SENTENCES

	#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_VERIFICATION	//not required	//should be activated for software verification	//can be disabled for specific debugging
	#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION	//GIA3j5aTEMP53	//not required 	//should be activated for software verification
	#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION
		#define GIA_DEBUG_GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION_CONTINUOUS	//GIA3j15a //continuous verification of GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION
	#endif
		
	
	//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_IDENTIFY_SEMANTIC_RELATIONS	//GIA3lXa	//untested //connect/associate simultaneously activated neurons (to semantic relation neuron)
	
	//#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN	//not yet defined
		#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_INDEX_DISPLAY_FORMAT_NUMBER_CHARACTERS (4)	//eg; instance=groupIndex:0001
	//#endif
	
	#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
	
		//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_SUPPORT_PARTIAL_SENTENCE_PROPAGATION	//not yet defined
			//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE	//not yet defined (generation code implementation has not yet been derived for ELONGATED_TREE)
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_LAST_COMPONENTS
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS	//GIA3l6b	
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS

						//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_RESET_IF_REPEATED_SEQUENCE_DETECTED	//not yet defined
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_RESET_IF_REPEATED_SEQUENCE_DETECTED_AND_WORD_INDEX_NOT_ALREADY_ENCAPSULATED_BY_HIGHER_LEVEL_GROUP_PREVIOUS_COMPONENT
						//#endif
						
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_GENERATE_DETECT_COVERAGE_SUPPORT_VARIABLE_END_COMPONENT	//GIA3l7c

                				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_REMEMBER_FIRST_COMPONENT_WORD_INDEX	//GIA3l7a	//see GIA_POS_REL_TRANSLATOR_SANI_ALLOW_MULTIPLE_ACTIVATIONS
                                        	#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_REMEMBER_FIRST_COMPONENT_WORD_INDEX
							//#assert GIA_POS_REL_TRANSLATOR_SANI_PARSE_SAVE_PARSE_TREE	//note GIA3l7b implementation currently requires memory of parseComponent->neuronComponentConnectionActiveWordRecord and parseComponent->parseTreeGroupRef such that the last components can be replaced/overwritten if necessary	//incompatible with principle/intent of GIA_POS_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY?
						#endif

						//#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_PRECHECKS	//not yet defined
							#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_PRECHECKS2	//GIA3l6c
						//#endif

						//replications of conditions defined in GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS;

						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS

						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_NON_STRING

						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_PREFERENCE_THEM	//this preferences merging existing groups over creating new groups 
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_DISABLE_MULTIPLE_INPUTS_IF_HAS_IDENTICAL_COMPONENTS

						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_RECORD_DEPTH
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE_MIN_NEURONS (2)
						#endif

						#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_MATCHING_DEPTH	//GIA3l6c
							#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_MATCHING_DEPTH
								#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS_X_COMP_REQUIRE_MATCHING_DEPTH
								#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_RECORD_DEPTH
								#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE
							#endif
						#endif

						//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//not yet defined

							//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENT_ALL_NEURONS_IN_FIRST_COMPONENT_SUBGROUPS_ARE_UNIQUE
							//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENT_ALL_NEURONS_IN_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE
							
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENT_FIRST_AND_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE
								...
								#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENT_FIRST_AND_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE_POST
								#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENT_FIRST_AND_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE_POST
									#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENT_FIRST_AND_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE_PRE
										...
										#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_HISTORY
										#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GENERATE_ENSURE_ALL_NEURONS_IN_SUBGROUP_ARE_NOT_USED_BY_ANY_NEW_CANDIDATE
									#endif
								#endif
							#endif
						//#endif
		...
		//#endif
			...
			//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS	//not yet defined
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS

				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_NON_STRING

				//#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_VARIABLE	//not yet defined
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_SIMPLIFIED	//GIA3l6a	//check dependency on findAndReconcileIncrementalVariationLimitNumComponentsSection (vs findAndReconcileIncrementalVariation)
				//#endif

				//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE	//not yet defined
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE_ALWAYS_UPDATE_COMPONENT_INDICES	//GIA3l6a	//redundant

					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_SIZEABLE_SUBTREE	//GIA3l5a
						...
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_RECORD_DEPTH
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_SIZEABLE_SUBTREE_MIN_NEURONS (2)
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_NON_STRING
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_NON_STRING_COMPREHENSIVE
						#endif
					#endif
				//#endif
			//#endif
	...
	//#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN	//not yet defined
		//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS	//not yet defined
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_CONTINUOUSLY_OUTPUT_NETWORK
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_CONTINUOUSLY_OUTPUT_NETWORK
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_CONTINUOUSLY_OUTPUT_NETWORK_PROPAGATION	//GIA3l1b
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_CONTINUOUSLY_OUTPUT_NETWORK_PROPAGATION
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_CONTINUOUSLY_OUTPUT_NETWORK_PROPAGATION_RESTRICT_TO_POST_GENERATION_PHASE	//only print propagation once network has been generated (after x sentences)	//requires inputText to include a duplication of all sentences halfway through file
						...
						#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_STORE_SENTENCE_INDEXING
					#endif
				#else
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_CONTINUOUSLY_OUTPUT_NETWORK_GENERATION	//GIA3l1a
				#endif
			#endif
		//#endif
	//#endif
	
	//#define GIA_POS_REL_TRANSLATOR_SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_ACTIVATION	//GIA3l1b	//for visualisation - ensure to sync ANNglobalDefs.hpp: ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_ACTIVE
	...
	#define GIA_POS_REL_TRANSLATOR_SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_COMPONENT_INDEX	//GIA3l1a	//for visualisation/debugging - ensure to sync ANNglobalDefs.hpp: ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_COMPONENT_ORDER
	#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_COMPONENT_INDEX
		//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS	//not yet defined
			#define GIA_POS_REL_TRANSLATOR_SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_COMPONENT_INDEX_EXACT
		//#else
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_TYPICAL_MAX_NUM_COMPONENTS (5)
		//#endif
	#endif
#endif
...
//#define GIA_DEBUG_DISABLE_3k_CODE
		...
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRINT_SUCCESSFULLY_TRACED_OR_GENERATED_PARSE_TREES	//GIA3k14b	//requires GIA_POS_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE:GIA_POS_REL_TRANSLATOR_SANI_PARSE_SAVE_PARSE_TREE
		
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_SENTENCES_FAIL_ONLY

		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_SINGLE_POS_PERMUTATION
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS
		//#ifdef GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS
		//	#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS_NUM (7)
		//#endif
		...
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_TIME
		
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_LIMIT_NUM_COMPONENTS
		
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_FORMATION2
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_TRACE
		#ifdef GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_TRACE
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA4

			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA3_PRIMARY
		#endif
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_BASIC
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_UPDATE_ACTIVATED_NEURON_WITH_MAX_WORD_INDEX_COVERAGE
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA3  //detailed debug
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_FORMATION
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_TRACE

		
		//QA variables:
		
		
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_ASSIGN_GROUP_INDICES_TO_INPUT_NEURONS	//GIA3k8c	//assign groupIndex to POS/input neurons

		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_THROW_SENTENCE_FAIL_ERROR_IF_ANY_POS_PERMUTATION_FAILS	//GIA3k14b - optional (usage of this parameter is dependent on user intention)
		...
		*/
		...
		#define GIA_POS_REL_TRANSLATOR_SANI_FORWARD_DIRECTION	//GIA3k17a

		#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_FIX	//GIA3k13a
		
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ALWAYS_STORE_COMPONENT_REFS	//GIA3k13a
		...
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_EXECUTE_WORD_CONNECTIVITY_TESTS_ONCE //execute sequentialActivationConnectivityTests at start to save multiple executions	//GIA3k11b	//mandatory GIA3k13a with GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY upgrade
		
		//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_ONLY_SUPPORT_MISSING	//GIA3k14d
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_ONLY_SUPPORT_MISSING
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_MISSING	//temporarily disable for debug only
				//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_VARIABLE
			#else
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_MISSING	//mandatory
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_VARIABLE	//mandatory	
			#endif
			/*
			NOTUSED:
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_MISSING
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_MISSING_OR_VARIABLE
			#endif
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_VARIABLE
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_MISSING_OR_VARIABLE
			#endif
			*/
		//#endif
		...
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS	//GIA3k1a
			...
			#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_PRECHECKS	//made optional GIA3k17b
			
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_NUM_COMPONENTS (2)	//each neuron has to have exactly 2 seq components
			#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_IGNORE_PARTIAL_DETECTIONS	//only detect fully activated neurons
			#endif	
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_ELONGATED_TREE
			#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_ELONGATED_TREE
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE	//GIA3k15a
			#endif
			
			//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_ELONGATED_TREE	//condition added GIA3k15g //condition removed GIA3k15h - REDUNDANT_WORD_CONNECTIVITY_CHECK are not required with GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_DISABLE_REDUNDANT_WORD_CONNECTIVITY_CHECKS	//GIA3k4a
			//#endif
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_RESET_IF_REPEATED_SEQUENCE_DETECTED	//GIA3k7a
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_RESET_IF_REPEATED_SEQUENCE_DETECTED
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_RESET_IF_REPEATED_SEQUENCE_DETECTED_ACTIVE	
				//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE
					//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_ACTIVATION_IF_REPEATED_SEQUENCE_MISMATCH_DETECTED	//GIA3k15c	//disabled GIA3k16a (not required with GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY)
				//#endif
			#endif
			
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_VERIFY_NO_CIRCULAR	//used for debugging (circular loops don't get generated by !GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS, or are generated much less often)
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS
				
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_DISABLE_MULTIPLE_INPUTS_IF_HAS_IDENTICAL_COMPONENTS	//GIA3k7a
		
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS	//GIA3k1b
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS
										
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_PREVENT_DUPLICATE_CONNECTIONS	//GIA3k14e
					
					//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//not yet defined
						//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GENERATE_INCREMENTALLY_SECTIONED_PREVENT_INTRASENTENCE_MATCHING_SECTIONED_RESET_AT_END	//untested
						//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GENERATE_ENSURE_ALL_NEURONS_IN_SUBGROUP_ARE_NOT_USED_BY_ANY_NEW_CANDIDATE	//disabled GIA3k13a

						//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENT_ALL_NEURONS_IN_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE		//GIA3k12a trial only
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_SIZEABLE_SUBTREE
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENT_ALL_NEURONS_IN_FIRST_COMPONENT_SUBGROUPS_ARE_UNIQUE	//GIA3l15a	//GIA3k12a trial only
						#endif
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_BASIC	//not yet defined
							//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GENERATE_ENSURE_ALL_NEURONS_IN_SUBGROUP_DO_NOT_HAVE_CONNECTIONS_TO_ANY_NEW_CANDIDATE	//GIA3k10c	//disabled GIA3k12a	//not yet implemented for GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_EFFICIENT
						#endif
					//#endif

					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_PREFERENCE_THEM	//GIA3k3a	//this preferences merging existing groups over creating new groups 

					//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_PRELIM_TEST	//GIA3k3a+	//not yet complete - requires definition of function copyRuleGroupType
					
					#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_SIZEABLE_SUBTREE
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_MATCHING_DEPTH	//GIA3k3a
							...
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS_X_COMP_REQUIRE_MATCHING_DEPTH
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_RECORD_DEPTH	//GIA3k6b
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE
						#endif
					#endif
										
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE	//GIA3k3a
					#endif
						...
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE_MIN_NEURONS (2)
					#endif
						
					#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS_X_COMP_REQUIRE_MATCHING_DEPTH
						//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_PRUNE	//GIA3k6+
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_PRUNE
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_OPTIONAL	//replicate pathway generation without supporting variable first components
						#endif
						//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_RANDOMISE	//GIA3k3a
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_RANDOMISE
							#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_RANDOMISE_PROB (0.5)	//probability of accepting variable 1st component (ie merge)
						#endif
					#endif

				#else
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_ENFORCE_FIRST_COMPONENT_NOT_VARIABLE	//GIA3k1b //merge not supported
					//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_ENFORCE_FIRST_COMPONENT_NOT_MISSING	//GIA3k1a	//merge not supported		
				#endif
			#endif
			
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GENERATE_INCREMENTALLY_SECTIONED	//GIA3k9a	//only currently supported by GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS

				#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE
					#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY	//GIA3k10a	//updated GIA3k13a	//activated GIA3k15h
				#endif
					...
					//#define GIA_POS_REL_TRANSLATOR_SANI_ALLOW_MULTIPLE_ACTIVATIONS	//GIA3k11a	//disabled GIA3l7a
				#endif
					
				//#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//not yet defined
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_EFFICIENT	//GIA3k12a
					#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_EFFICIENT
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_BASIC	//disabled GIA3k12a
				...
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_OPTIMISE_FOR_DIVERGENT_CONVERGENT_PATHWAYS	//GIA3k5a
			#endif
...
//#define GIA_DEBUG_DISABLE_3j_CODE
#ifndef GIA_DEBUG_DISABLE_3j_CODE

	//#define GIA_POS_REL_TRANSLATOR_SANI_SEMANTICALLY_DETERMINED_DYNAMIC_CONNECTIONS	//GIA3j1a	//incomplete

	//#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_OLD_BUG	//disabled GIA3j2aTEMP88
	...
	//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR	//GIA3j2a
		...
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS	//GIA3j5a
			...
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_DETECT_LOCAL_VARATION	//GIA3j3a	//untested
		#endif
		#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ORIG	//this shouldnt ever be necessary, but restores code to precise GIA3j4a functional state
		#endif
		...
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS
		//#ifdef GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS
		//	#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_POS_PERMUTATIONS_NUM (20)
		//#endif
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_TEST_VERIFICATION_AFTER_GENERATION	//requires inputText to include a duplication of all sentences halfway through file
			
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR2
		#ifdef GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR2
			#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_TRACE
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_BASIC
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_WORDCONNECTIVITY_VERIFICATION
			...
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
		#endif
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR	//temp
		#ifdef GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR
			#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_TRACE
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_BASIC
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_WORDCONNECTIVITY_VERIFICATION
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_SPLIT
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_NEVER_SPLIT_GROUP_BETWEEN_TWO_IDENTICAL_COMPONENTS
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_TEST_VERIFICATION_AFTER_GENERATION	//requires inputText to include a duplication of all sentences halfway through file
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_TEST_VERIFICATION_PROPAGATION_IN_OPPOSITE_DIRECTION	//temp test only	//FAIL@GIA3j2aTEMP134, OK@GIA3j2j
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_SINGLE_POS_PERMUTATION
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRINT_GROUP_INDICES
			
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_WORDINDEX_VERIFICATION   //detailed debug
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA3  //detailed debug
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA4
			#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
		#endif
		...
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION	//GIA3j5aTEMP53	//not required 	//should be activated for software verification
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_VERIFICATION	//not required	//should be activated for software verification	//can be disabled for specific debugging
		#define GIA_POS_REL_TRANSLATOR_SANI_SIMPLE_WORD_POS_TYPE_INPUT_ONLY


		#define GIA_POS_REL_TRANSLATOR_SANI_ANN_CENTRE_NEURONS
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN_CENTRE_NEURONS
			#define GIA_POS_REL_TRANSLATOR_SANI_ANN_CENTRE_NEURONS_X_AXIS
			#define GIA_POS_REL_TRANSLATOR_SANI_ANN_SEGREGATE_TOP_LAYER_NEURONS
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN_SEGREGATE_TOP_LAYER_NEURONS
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_SEGREGATE_TOP_LAYER_NEURONS_Y_SEPARATION (10)
			#endif
		#endif

		//algorithm tweaks:
		//#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//not yet defined
			#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_FORCE_RESET_IF_NO_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//GIA3j2bTEMP19	//mandatory //disabled GIA3k10b	//this test as currently implemented does not work
			#endif
			#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_DISABLE_REDUNDANT_WORD_CONNECTIVITY_CHECKS
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY_BETWEEN_NEWLY_ACTIVATED_COMPONENT_AND_PREVIOUSLY_ACTIVATED_GROUP	//GIA3j2bTEMP21-24
			#endif
				...
				//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY_BETWEEN_NEWLY_ACTIVATED_COMPONENT_AND_PREVIOUSLY_ACTIVATED_GROUP_INST	//GIA3j5aTEMP56
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY_BETWEEN_NEWLY_ACTIVATED_COMPONENT_AND_PREVIOUSLY_ACTIVATED_GROUP_OPTIMISED	//GIA3j2c
					...
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY_BETWEEN_NEWLY_ACTIVATED_COMPONENT_AND_PREVIOUSLY_ACTIVATED_GROUP_OPTIMISED2	//GIA3j2c
				#endif
			#endif
		//#endif
		#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_NEVER_SPLIT_GROUP_BETWEEN_TWO_IDENTICAL_COMPONENTS	//added GIA3j2bTEMP8-TEMP9, updated GIA3j2bTEMP14-TEMP16	//this prevents algorithm issues involving repeated words (or sequences)
		#endif
		#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_NEVER_SPLIT_GROUP_BETWEEN_TWO_IDENTICAL_COMPONENTS
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_WRITE_IF_UPPER_NEURON_ALREADY_CONTAINS_WORD_INDEX_OF_EXISTING_COMPONENT	//added GIA3j2aTEMP145, removed GIA3j2aTEMP8
		#endif
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_RESET_IF_NEXT_SEQUENCE_IS_SAME_AS_CURRENT_SEQUENCE	//GIA3j2aTEMP143
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_RESET_IF_FIRST_INACTIVE_COMPONENT_GROUPREF_IS_SAME_AS_FUTURE_ACTIVE_COMPONENT_GROUPREF	//GIA3j2aTEMP126, updated GIA3j2bTEMP18
			...
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_RESET_IF_FIRST_INACTIVE_COMPONENT_GROUPREF_IS_SAME_AS_FUTURE_ACTIVE_COMPONENT_GROUPREF_RECURSIVE	//GIA3j2aTEMP129 (never used?)
		#endif
		
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_WEIGHTS	//strengthen groups/componentConnections depending on usage
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_WEIGHTS
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_WEIGHTS_PRINT_COLOURS	//GIA3j2j
		#endif
		
		//#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//CHECKTHIS
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_BASIC
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_BASIC
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_HISTORY
					#endif
					#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GENERATE_ENSURE_ALL_NEURONS_IN_SUBGROUP_ARE_NOT_USED_BY_ANY_NEW_CANDIDATE	//disabled GIA3k13a, conditionally activated GIA3k17b
					#endif
				#endif
			#endif
		//#endif
		
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_TOP_LEVEL_NEURON_DUPLICATION
		#define GIA_POS_REL_TRANSLATOR_SANI_ANN_DELAY_ANN_CONNECTIVITY_TILL_END
		
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_SUPPORT_PARTIAL_SENTENCE_PROPAGATION
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PERFORM_AUTORESET_OF_ACTIVATIONS		
		
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_SUPPORT_OPTIONAL_COMPONENTS	//not supported as groups may be split in the future, preventing propagation algorithm from functioning properly (NB propagation algorithm does not support optional components at "end" [ie lastIndex] of group)
		
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GROUP_TYPE_NAME "sequenceGrammarAutoGeneratedGroups"
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GROUP_TYPE_REFERENCE_SET_TYPE (3) //GIA_POS_REL_TRANSLATOR_RULES_GROUPS_REFERENCE_SET_TYPE_SUBREFERENCESET "subReferenceSet"
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GROUP_NAME "sequenceGrammarAutoGeneratedGroup"
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_NEURON_NAME "generated"
		
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET	//generates preliminary (non-functional) representation of sequence grammer network exclusively using ANNneuronClass rather than GIAposRelTranslatorRulesGroupClass:ANNneuronClass
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET
				...
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE
				...
				#endif
			#else
				//assume compiled with COMPILE_ANN+ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_ANN_DATAFILE_NAME "POStaggerOutputClassificationNetExperiencesDataFile.dat"
				#ifdef COMPILE_ANN
					...
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK	//required for certain functions from GIApreprocessorPOStaggerClass
					#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_ANN
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_ANN
						#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_ANN_EMULATE_EXACT_POS_TAGGER_DATABASE_OUTPUT	//relies on GIApreprocessorPOStaggerClass::generateANNexperienceFromPOSambiguityInfoPermutation from COMPILE_GIA_GENERATE_POS_TAGGER_DATABASE rather than GIAposRelTranslatorSANIPropagateCompactClass::propagateWordThroughNetworkIntro from GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_INTEGRATED
					#endif
				#endif
			#endif
			...
			//final version (non testing) 
			#ifdef COMPILE_GIA_GENERATE_POS_TAGGER_DATABASE	//ie GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE
				//execute GIAposRelTranslatorSANIPropagateCompactGenerate directly/immediately on wikidump POS tag derivations
				//assume compiled with COMPILE_GIA_WITH_ANN_GENERATE_POS_TAGGER_DATABASE
				#define GIA_PREPROCESSOR_POS_TAGGER_GENERATE_NEURAL_NETWORK_SEQUENCE_GRAMMAR		
					...
					#define GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE_RAW	//this is an adaption of GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE to output entire sentence POS rather than that centred on a particular word
					//#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_INTERNAL_CLASSIFICATION_NET	//uses these variables
					//#ifdef GIA_PREPROCESSOR_POS_TAGGER_DATABASE_FEED_ALL_PERMUTATIONS_INDIVIDUALLY_ONLY_TRAIN_UNAMBIGUOUS_PERMUTATIONS	//not yet defined	//recommended/required for train efficiency	//CHECKTHIS is compatible with GIA_PREPROCESSOR_POS_TAGGER_GENERATE_NEURAL_NETWORK_SEQUENCE_GRAMMAR
						//#define GIA_PREPROCESSOR_POS_TAGGER_GENERATE_NEURAL_NETWORK_SEQUENCE_GRAMMAR_ONLY_TRAIN_UNAMBIGUOUS_PERMUTATIONS	//disabled GIA3k7a		
					//#endif
				...
				//assume compiled with COMPILE_GIA or COMPILE_GIA_WITH_ANN
					//ensure to compile GIAwithANN (activates USE_ANN: GIA_POS_REL_TRANSLATOR_SANI_ANN) to print network
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_INTEGRATED
					//note supports GIA_POS_REL_TRANSLATOR_SANI_PARSE/GIA_POS_REL_TRANSLATOR_SANI_PARSE_SAVE_PARSE_TREE
					//note doesn't support GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS/GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE/semantic network generation (GIAtranslator.parseNLPparserFileAndCreateSemanticNetworkBasedUponDependencyParsedSentences)
			#endif
		#endif	
		
		//see GIAposRelTranslatorSANIPropagateCompactClass::propagateWordThroughNetworkIntro: GIA_POS_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_AS_WILDCARDS is not supported, GIA_POS_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_AS_NOUNS is required
		
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_ORIG
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_ORIG
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_NUMBER_COMPONENTS (2)	//this prevents the need to split neuronal components (biological feasibility)
				//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2_ADD_ALL_PERMUTATIONS	//add all 2-tuples in sequence (ie overlapping; start odd/0 and start even/1), else add first available/consecutive 2-tuples in sequence (start odd/0 only)
			#else
				#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_NUMBER_COMPONENTS (2)	//try 3, 4 etc
			#endif
		#endif
		#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS
			//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS_ENFORCE_DURING_SPLIT_OLD	//GIA3j2f
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS_ENFORCE_DURING_FIRST_HIDDEN_LAYER_GENERATION	//GIA3j2f	//requires GIA_POS_REL_TRANSLATOR_SANI_ANN_DELAY_ANN_CONNECTIVITY_TILL_END
			#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MIN_NUM_COMPONENTS (2)	//each neuron has to have at least 2 components
		#endif
		//#define GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_NUMBER_LAYERS (200)	//adjust //~=GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE_RAW_SENTENCE_MAX_NUM_WORDS
		

		#define GIA_POS_REL_TRANSLATOR_SANI_COMPACT
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_COMPACT

			#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_NEW

			#define GIA_POS_REL_TRANSLATOR_SANI_REPLICATE_TOP_LEVEL_PARSE_TREE
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_REPLICATE_TOP_LEVEL_PARSE_TREE
				#define GIA_POS_REL_TRANSLATOR_SANI_DONT_SET_NEURON_TRACED	//GIA3g11o	//experimental
				#define GIA_POS_REL_TRANSLATOR_SANI_FREE_MEMORY	//GIA3g11p
			#endif
						
			#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
				#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT
					#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_SUM
				#endif
				#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_DYNAMIC
			#endif

			#define GIA_POS_REL_TRANSLATOR_SANI_RESET_COMPONENT_NEURONCOMPONENTCONNECTIONACTIVEWORDRECORD
			
			#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
				#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION
					#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC
						#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT
							#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT_MUTUALLY_EXCLUSIVE
						#endif
					#endif
				#endif
			#endif
			#ifndef GIA_POS_REL_TRANSLATOR_SANI_FORWARD_DIRECTION
				#define GIA_POS_REL_TRANSLATOR_SANI_REVERSE_DIRECTION	//mandatory //required to support recursion (parse sentences from right to left); eg (Tom said that (Mary said))
			#endif
			
			#define GIA_POS_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY	//GIA3h2a	//assume cannot backprop through parseTreeGroupNeuralNet
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY
				#define GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK0	//requires lastParseComponent->parseTreeGroupRef
				#define GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK1	//requires previousParseComponent->parseTreeGroupRef
				//#define GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK2	//store component's->parseTreeGroupRef for 1 layer
				//#define GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK3	//can backprop through groupNeuralNet but not parseTreeGroupNeuralNet
				
				#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_BIO	//GIA3i1a
				#endif
				//#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_BIO
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK0	//ie GIA_POS_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY_WEAK
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK1
							//#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_DYNAMIC	//not yet defined
								#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_DYNAMIC_BIO	//GIA3i1a
								#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_DYNAMIC_BIO
									#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_WEIGHT_BIO	//GIA3i1a
								#endif
							//#endif
						#endif
					#endif
...
//#define GIA_DEBUG_DISABLE_3i_CODE
	...
	//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PRINT_FINAL
	//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PRINT_FINAL2
	...
	#ifdef GIA_POS_REL_TRANSLATOR_SANI		
		//#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE	//not yet defined
			
			//#ifdef GIA_POS_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//not yet defined
				#define GIA_POS_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS_OR_OPTIONAL_REPEAT	//3i3b
			//#endif
			
			#ifndef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR
				#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PRELIM	//temp var for debug; must be set if GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED is set
			#endif
			//#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED	//not yet defined
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PRELIM
				#define GIA_POS_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY	//GIA3h2a	//assume cannot backprop through parseTreeGroupNeuralNet
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY
					#define GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK0	//requires lastParseComponent->parseTreeGroupRef
					#define GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK1	//requires previousParseComponent->parseTreeGroupRef
					...
					//TODO: create a GIA_POS_REL_TRANSLATOR_SANI_VERIFY_OWNER_GROUP_DOESNT_CONTAIN_NEWLY_ACTIVATED_COMPONENT_IN_ITS_PARSE_TREE_BIO method


					//TODO: create a GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_BIO method that works
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK1
						//#define GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_BIO_WEAK1	//GIA3i1a	//doesnt work
					#endif
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_BIO_WEAK3
						//define GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_BIO_WEAK3	//not yet coded	
					#endif
				#endif
			
				#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS	//GIA3i1a	//optional	//equivalent to old <GIA3g1i !GIA_POS_REL_TRANSLATOR_SANI_PARSE_SEPARATE
				
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC
						#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_OPTIMISED	//same speed as !GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS	//save optimum paths for every sentence once, and use this trace multiple times during GIA advanced referencing
						#ifndef GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_OPTIMISED
							#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_UNOPTIMISED	//4x slower than !GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS	//unfinished (not yet implemented for USE_NLC:GIA_POS_REL_TRANSLATOR_RULES_PARSE_ISOLATED_SUBREFERENCE_SETS)
							#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_UNOPTIMISED
								//#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_ONLY_PEFORM_PRELIM_PROPAGATION_IF_ADVANCED_REFERENCING
									...
									#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_OLD
								#endif		
							#endif
						#endif		
						#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_STREAMLINED	//mandatory
					#endif
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_DELETE_INCOMPLETE_PATHS_SEMANTIC_RELATIONS	//GIA3i1a
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSER	//GIA3g1c->GIA3g1h, GIA3i1a
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSER
						#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_BIO	//GIA3i1a	//currently mandatory (non bio implementation is not robust)	//parseTreeGroups are logically reducible to groups, parseTreeComponents are logically reducible to components [they just specify the parse relevant properties of the group/components]
						//#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_BIO_LIMIT_GENERATION_OF_SEM_NET_FROM_INCOMPLETE_PATHS	//trial GIA3i1aTEMP35
					#endif
				#endif
			#endif
			//#endif
			...
			#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE	//GIA3i1a	//equivalent to old <GIA3g1i GIA_POS_REL_TRANSLATOR_SANI_PARSE	//required for performance calculations only (doesnt assume parse tree is generated or saved)
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS
				#ifndef GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_BIO
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
				#endif
				#ifndef GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_BIO
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
				#endif
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY_WEAK
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE	//requires previousParseComponent->parseTreeGroupRef
				#endif
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_DELETE_INCOMPLETE_PATHS_SEMANTIC_RELATIONS
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SAVE_PARSE_TREE	//this is required to set optimumPaths via backprop of final generated parse tree
				#endif
			#else
				#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
					#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_SAVE_PARSE_TREE
				#endif
			#endif
		//#endif
	#else
...
//#define GIA_DEBUG_DISABLE_3h_CODE
#ifndef GIA_DEBUG_DISABLE_3h_CODE
	
	#ifdef GIA_POS_REL_TRANSLATOR_SANI			
		#ifdef USE_ANN
			#ifndef COMPILE_GIA_GENERATE_POS_TAGGER_DATABASE_ORIG
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN	//GIA3h3a
			#endif
				...
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES	//GIA3h3a	//reduces display x (width) - more compact	
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES
					#define GIA_POS_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES2	//GIA3h3b	//optional; no change in output
				#endif
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_SUPPORT_RECURSION	//where recursion prevents optimisation of display y coordinate of groupType, use its position within the xml file

				//#define GIA_POS_REL_TRANSLATOR_SANI_ANN_ADD_LAYER_FOR_EVERY_GROUP_TYPE	//GIA3g1a	//optional - not currently used

				#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES
					#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_SPACING_X (5)
				#else
					#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_SPACING_X (100)	//max number of neurons per artificial groupType
				#endif
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_SPACING_Y (5)	//max number of layers in artificial groupType
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES
					#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_SPACING_X (5)
				#else
					#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_SPACING_X (20)	//max number of neurons per groupType
				#endif
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_SPACING_Y (2)	//max number of layers in groupType
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_SPACING_X (1)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_SPACING_Y (1)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_SPACING_X (1)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_SPACING_Y (1)

				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_X (0)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_Y (0)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_X_WORDPOSTYPE (0)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_X_EXPLICITWORD (1)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_X_EXPLICITTOKENSLAYER (2)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_WORDPOSTYPE (0) 
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_WORDPOSTYPE_NOUN_VERB_VARIANTS (1)  				    
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITWORD (0)											    
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER (0)			    
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER_LAYER_CLASS_TYPE_INSTANCE (0)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER_LAYER_CLASS_TYPE (1)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER_LAYER_CLASS (2)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER_LAYER (3)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_SUBGROUP_ARTIFICIAL_SPACING_X (3)

				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_INPUT_POSITION_X (0)
				#define GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_INPUT_POSITION_Y (GIA_POS_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_SPACING_Y)
			#endif
		#endif
	#endif
#endif
...
//#define GIA_DEBUG_DISABLE_3g_CODE
	...
	#define GIA_POS_REL_TRANSLATOR_SANI_COMPONENT_INDEX_FIRST (0)	//3g6a
	#ifdef GIA_POS_REL_TRANSLATOR_SANI
	
		//light optimised debug only;		
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA9

		//light unoptimised debug only;
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA8
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA7
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA6
		
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA5
		
		//common debug;
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA4
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA3
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_PROPAGATE
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_SANI_CREATE
		//#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES
		
		#define GIA_POS_REL_TRANSLATOR_SANI_WORD_INDEX_W_TO_ENTITY_INDEX_OFFSET (1)	//w starts at 0, sentence entityIndex starts at 1
	
		#define GIA_POS_REL_TRANSLATOR_RULES_DEFINE_GROUP_TYPE_BACKUP_AT_START	//GIA3g1b
		#define GIA_POS_REL_TRANSLATOR_RULES_DEFINE_WORD_TRANSLATOR_SENTENCE_ENTITY_INDEX_AT_START	//GIA3g1a	//required for GIA_POS_REL_TRANSLATOR_SANI
		
		#define GIA_POS_REL_TRANSLATOR_SANI_REPEAT_SEQUENCES_ENFORCE_CONSECUTIVE_STRING_COMPONENTS	//GIA3g1h

		#ifndef GIA_POS_REL_TRANSLATOR_SANI_SIMPLE_WORD_POS_TYPE_INPUT_ONLY
			#define GIA_POS_REL_TRANSLATOR_SANI_CREATE_NEURONS_FOR_NOUN_VERB_VARIANTS	//GIA3g1a
		#endif
		
		//#ifdef GIA_POS_REL_TRANSLATOR_RULES_CODE_GROUP_PREVIOUS_WORD_POS_TYPE //not yet defined
			#define GIA_POS_REL_TRANSLATOR_SANI_PREVIOUS_WORD_POS_TYPE_CHECKS	//GIA3g1a	//GIA3g1aTEMP61
		//endif
			
		#define GIA_POS_REL_TRANSLATOR_SANI_PARSE	//GIA3g1c
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE
			#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_RECORD_PERFORMANCE	//GIA3g1cTEMP14
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_RECORD_PERFORMANCE
				//#define GIA_POS_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_RECORD_PERFORMANCE_METHOD_OLD_INCREMENT_FOR_EVERY_GROUP_REF_RECURSE
			#endif	
		#endif
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
			...
			//#define GIA_POS_REL_TRANSLATOR_SANI_HEAVY	//GIA3g6-9
			#ifdef GIA_POS_REL_TRANSLATOR_SANI_HEAVY
				//heavy: maintain multiple instances of the neural network in memory

				//#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_STRICT_ITERATION_INDICES	//created and disabled GIA3g9c

				#define GIA_POS_REL_TRANSLATOR_SANI_SAVE_MEMORY_GROUPS	//GIA3g6a

				#define GIA_POS_REL_TRANSLATOR_SANI_HEAVY_OPTIMISED	//GIA3g8-9
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_HEAVY_OPTIMISED

					#define GIA_POS_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//optional: does not simplify algorithm

					#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE	//GIA3g8h	//required to emulation !GIA_POS_REL_TRANSLATOR_SANI?
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE
						#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS	
							...
							//#ifdef USE_NLC	//remove this requirement in future (after GIA auto testing recompleted)
								#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
								#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
									#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT	//GIA3g9c
									#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT
										#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_SUM //3g10a	//requires testing
									#endif
								#endif
								#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_WEAK			//GIA3g9b
								#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_WEAK
									#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_WEAK_OFFSET (1)
								#endif
							//#endif
						#endif
					#endif

					#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY	//GIA3g8aTEMP51
					#define GIA_POS_REL_TRANSLATOR_SANI_MAX_ITERATIONS (9)
					#define GIA_POS_REL_TRANSLATOR_SANI_EFFICIENCY_STORE_POINT_ARRAY_IN_BASE_GROUP	//GIA3g8aTEMP28	

				#else
					#define GIA_POS_REL_TRANSLATOR_SANI_HEAVY_UNOPTIMISED	//GIA3g6-7

					//#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT_OLD	//why was this never defined?

					#define GIA_POS_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//optional: significantly simplifies algorithm

					#ifndef GIA_POS_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS
						#define GIA_POS_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS
							#define GIA_POS_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS_METHOD2	//GIA3g6aTEMP54	//requires GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT
							//#define GIA_POS_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS_METHOD1	//GIA3g6a, disabled GIA3g6aTEMP54
							#ifdef GIA_POS_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS_METHOD1
								//#define GIA_POS_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS_EFFICIENT	//GIA3g6aTEMP28, disabled GIA3g6aTEMP53 until debugged
							#endif
						#endif
					#endif

					#define GIA_POS_REL_TRANSLATOR_SANI_SUPPORT_RECURSION	//GIA3g6a	//this is now mandatory (regardless of recursion, because group reset has been disabled)

					#define GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP		//GIA3g1aTEMP54	//GIA3g6a
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP
						#define GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP_AFTER_ACTIVATING_INDIVIDUAL_COMPONENTS	//GIA3g1aTEMP35	//GIA3g6a		
					#endif

					#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
						#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//GIA3g6aTEMP55	//make sure there is adjacent word connectivity between previous active components and newly activated component - ie no word indices are skipped
						#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD	//GIA3g6bTEMP4
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD
							#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD_NOUNS_ONLY
							#ifndef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD_NOUNS_ONLY
								#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD_MULTIPLE_ACTIVATION_HYPOTHESES	//can perform pass through through multiple unactivated groups
							#endif
						#endif
						#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BASIC	//GIA3g1x		
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BASIC
							//#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BASIC_MAX_1_CONSECUTIVE_ISOLATED_WORDS	//GIA3g1x	//reactivated GIA3g6aTEMP58
							//#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BASIC_CONSECUTIVE_WORDS_SAME_POSTYPE	//GIA3g6aTEMP58
						#endif
						#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC	//GIA3g1b
					#endif 
				#endif

				//#define GIA_POS_REL_TRANSLATOR_SANI_PREVENT_CIRCULAR_CONNECTION_LOOPS	//GIA3g1a	//temporarily enabled until determined due to parse these	//disabled GIA3g6a
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_SAVE_MEMORY_GROUPS
					#define GIA_POS_REL_TRANSLATOR_SANI_SAVE_MEMORY_GROUPS_PREVENT_CIRCULAR_CONNECTION_LOOPS	//added GIA3g6a
				#endif

			#else
				#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT	//GIA3g10a
				//light: only ever maintain a single instance of the neural network in memory
				#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT
					#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED		//GIA3g11a
					#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED 

						#define GIA_POS_REL_TRANSLATOR_SANI_REPLICATE_TOP_LEVEL_PARSE_TREE	//GIA3g11f - required for GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_REPLICATE_TOP_LEVEL_PARSE_TREE
							#define GIA_POS_REL_TRANSLATOR_SANI_DONT_SET_NEURON_TRACED	//GIA3g11o	//experimental
							#define GIA_POS_REL_TRANSLATOR_SANI_FREE_MEMORY	//GIA3g11p
						#endif

						#define GIA_POS_REL_TRANSLATOR_SANI_ADD_EXPLICIT_WORD_REFERENCES_AS_INDEPENDENT_POS_PERMUTATIONS	//GIA3g11m
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_ADD_EXPLICIT_WORD_REFERENCES_AS_INDEPENDENT_POS_PERMUTATIONS
							#define GIA_POS_REL_TRANSLATOR_SANI_ADD_EXPLICIT_WORD_REFERENCES_AS_INDEPENDENT_POS_PERMUTATIONS_EFFICIENT
						#endif

						#define GIA_POS_REL_TRANSLATOR_SANI_VERIFY_OWNER_GROUP_DOESNT_CONTAIN_NEWLY_ACTIVATED_COMPONENT_IN_ITS_PARSE_TREE	//GIA3g11e

						#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
							#ifndef GIA_POS_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_BIO_LIMIT_GENERATION_OF_SEM_NET_FROM_INCOMPLETE_PATHS
								#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT	//GIA3g11cTEMP6
							#endif
							#ifdef GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT
								#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_SUM
							#endif
							#define GIA_POS_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_DYNAMIC					//GIA3g11kTEMP3 //when existingActivationFoundStartComponent, and deciding whether to overwrite a component, if the prospectiveNewlyActivated component captures the exact same number of words as the existingActivatedComponent, select the path with the highest group weight
						#endif
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE	
							#define GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP		//GIA3g11j	//GIA3g1cTEMP4	//disabled GIA3g1cTEMP5
							#ifdef GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP
								#define GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP_AFTER_ACTIVATING_INDIVIDUAL_COMPONENTS	//GIA3g1cTEMP4	
								#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_SOLIDIFY	//preprocessor tag for GIAposRelTranslatorRules.xml
							#endif
						#endif

						#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS	//GIA3g11aTEMP57
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS
							#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_RESET	//GIA3g11aTEMP57
							#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS	//3g11aTEMP63
							#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS
								#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS_MOD	//GIA3g11i
								/*
								#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS_MOD
									#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS_MOD2	//GIA3g11j
								#endif
								*/
							#endif
							//#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_COMPONENT_WHEN_NEW_COMPONENT_AVAILABLE	//GIA3g11aTEMP79	//disabled GIA3g11aTEMP81
						#endif

						#define GIA_POS_REL_TRANSLATOR_SANI_RESET_COMPONENT_NEURONCOMPONENTCONNECTIONACTIVEWORDRECORD	//GIA3g11aTEMP46

						#define GIA_POS_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//mandatory

						#define GIA_POS_REL_TRANSLATOR_SANI_REVERSE_DIRECTION	//mandatory //required to support recursion (parse sentences from right to left); eg (Tom said that (Mary said))

						#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
							#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC	//CHECKTHIS
							#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC
								#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT	//CHECKTHIS
								#ifdef GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT
									#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT_MUTUALLY_EXCLUSIVE	//GIA3g11g
								#endif
							#endif
							#define GIA_POS_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//CHECKTHIS
						#endif

						#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_NEW	//new code specific to GIA_POS_REL_TRANSLATOR_SANI_LIGHT encapsulated for reference only

						#define GIA_POS_REL_TRANSLATOR_SANI_ALLOW_MULTIPLE_ACTIVATIONS	//mandatory
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_ALLOW_MULTIPLE_ACTIVATIONS
							#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS_TAKE_LAST_ACTIVATION_AS_PARSETREE	//mandatory (alternate method not implemented)
							#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS_VERIFY_MAX_NUMBER_OF_WORDS_IN_PARSETREE
							#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS_VERIFY_CONTAINS_EXISTING_WORDS_IN_PARSETREE	//GIA3g11aTEMP46
						#endif
						#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT	//mandatory
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT
							#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_ENSURE_FIRST_COMPONENT_ACTIVE_NEW	//added GIA3g11aTEMP70, GIA3g11aTEMP74
							#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESTORE
							#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_WORD		//rely on existingActivationFoundStartComponent instead
							#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_WORD
								#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_WORD_SUPPORT_RECURSION	//GIA3g11aTEMP37
								//#ifndef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS_VERIFY_CONTAINS_EXISTING_WORDS_IN_PARSETREE
								#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_WORD_BASIC	//GIA3g11aTEMP44
								//#endif
							#endif
						#endif
					#else
						#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_UNOPTIMISED	//GIA3g10a

						#define GIA_POS_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//mandatory

						#define GIA_POS_REL_TRANSLATOR_SANI_REVERSE_DIRECTION	//required to support recursion (parse sentences from right to left); eg (Tom said that (Mary said))
						...
						//#define GIA_POS_REL_TRANSLATOR_SANI_PREVENT_CIRCULAR_CONNECTION_LOOPS
						//#define GIA_POS_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP	//TODO: work out if this requires reimplementation

						#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_NEW	//new code specific to GIA_POS_REL_TRANSLATOR_SANI_LIGHT encapsulated for reference only
						#ifdef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_NEW
							#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_MEM
							#ifndef GIA_POS_REL_TRANSLATOR_SANI_LIGHT_MEM
								//perform restore of neuron activations based on their associated word index rather than local memory
								#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_BIO	//method without storing ownerGroupOrig in C++ memory
								//#define GIA_POS_REL_TRANSLATOR_SANI_LIGHT_BIO2	//NOTYET CODED //determine method to restore using groupFrontComponentConnectionListIndex and numberOfWordsCurrentlyParsed
							#endif
						#endif
					#endif
				#endif
			...
			#define GIA_POS_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS_ARTIFICIAL_GROUP_NAME_APPEND1 "ArtificialOptionalPermutationX1"
			#define GIA_POS_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS_ARTIFICIAL_GROUP_NAME_APPEND2 "ArtificialOptionalPermutationX2"
		#endif
			
	#else
		#define GIA_POS_REL_TRANSLATOR_INVERSE_NEURAL_NETWORK	//GIA3f
	#endif
#endif
