...
//#define GIA_DEBUG_DISABLE_3j_CODE
	...
	#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR	//3j2a	//verifies that  //more integrated alternative to ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK
		...
		//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET	//generates preliminary (non-functional) representation of sequence grammer network exclusively using ANNneuronClass rather than GIAtxtRelTranslatorRulesGroupClass:ANNneuronClass
			...
			//final version (non testing) 
				...
				#define GIA_PREPROCESSOR_POS_TAGGER_GENERATE_NEURAL_NETWORK_SEQUENCE_GRAMMAR
					...
					//CHECKTHIS parameter: GIA_PREPROCESSOR_POS_TAGGER_DATABASE_FEED_ALL_PERMUTATIONS_INDIVIDUALLY_ONLY_TRAIN_UNAMBIGUOUS_PERMUTATIONS - it is not currently being used by GIA_PREPROCESSOR_POS_TAGGER_GENERATE_NEURAL_NETWORK_SEQUENCE_GRAMMAR
				#endif
			#else
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS
			...
			//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS_ENFORCE_DURING_SPLIT	//GIA3j2f
