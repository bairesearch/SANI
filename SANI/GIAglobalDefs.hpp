...
//#define GIA_DEBUG_DISABLE_3g_CODE
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE	//3g1c
			...
			//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE_BASIC	//depreciated: modify and execute GIAtxtRelTranslatorParserClass::generateSemanticRelationsFromTxtRelations rather than adapting this code for GIAtxtRelTranslatorNeuralNetwork
				...
				//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE_BASIC_UPON_ACTIVATION_RESET	//probably not robust as reset will not necessarily be called
			#endif
		#endif

		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY
		#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENFORCE_WORD_CONNECTIVITY	//3g1d - emulates GIA_TXT_REL_TRANSLATOR_INVERSE_NEURAL_NETWORK: reject all activation paths that do not connect to a previous word in sentence	//for every activation path, expect to see a particular word (ie the preceeding word) in the first previous activated component detected, and if not reject the activation path (deactivate it)
			#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENFORCE_WORD_CONNECTIVITY
				//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SAVE_PARSE_TREE	//3g1d	//alternative implementation that saves parsed neural net in separate data structure
				#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SAVE_PARSE_TREE
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE_SEPARATE
				#endif
			#endif
			//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_OLD	//3g1b
			#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_OLD
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_OLD_WEAK
				#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_OLD_WEAK
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_OLD_WEAK_MIN_NUMBER_OF_RECENCY_GRADATIONS (2)
				#endif
			#endif
		#endif
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_DO_NOT_SET_SUBCOMPONENT_ACTIVATION_UNLESS_SET_COMPONENT_ACTIVATION	//3g1b - more consistent behaviour (required by GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_OLD)

		//#ifdef GIA_TXT_REL_TRANSLATOR_RULES_CODE_GROUP_PREVIOUS_WORD_POS_TYPE //not yet defined
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREVIOUS_WORD_POS_TYPE_CHECKS	//3g1a
			#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREVIOUS_WORD_POS_TYPE_CHECKS
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREVIOUS_WORD_POS_TYPE_CHECKS_GLOBAL	//GIA3g1aTEMP61
			#endif
		//endif
		...
		//#define GIA_TXT_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START	//GIA3g1aTEMP47	//GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE does not currently robustly support GIA_TXT_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START
			...
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PARSE_RECORD_PERFORMANCE	//GIA3g1cTEMP14
				...
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_STORE_MULTIPLE_BACK_PARSETREE_GROUP_REFS
			#endif
		#endif
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS	//GIA3g1aTEMP49
			...
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_PRECISE	//GIA3g1aTEMP52
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_SOLIDIFY_NET	//GIA3g1aTEMP54
			#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_SOLIDIFY_NET
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_SOLIDIFY_NET_BREAK_ALL_CONNECTIONS_TO_INACTIVE_GROUPS	//GIA3g1aTEMP57
			#endif
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ADD_ANN_LAYER_FOR_EVERY_GROUP_TYPE	//3g1a	//optional - not currently used
