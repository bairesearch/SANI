...
//#define GIA_DEBUG_DISABLE_3g_CODE
	...
	#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK	//3g1a
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY	//tested 3g1e
			...
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENFORCE_WORD_CONNECTIVITY	//3g1e - emulates GIA_TXT_REL_TRANSLATOR_INVERSE_NEURAL_NETWORK: reject all activation paths that do not connect to a previous word in sentence			//for every possible activation path for a word, select the one which connects to the group containing the most recent activated component
				...
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_WEAK
					...
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_WEAK_DISALLOW_RESETS	//3g1g
				#endif
			#endif
		#endif
		...
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS	//GIA3g1aTEMP49
			...
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_DYNAMIC_RESET
			#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_DYNAMIC_RESET
				//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_DYNAMIC_RESET_INCLUDE_PARTIALLY_OR_FULLY_ACTIVATED_GROUPS		//GIA3g1h (not used)
				#ifndef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_DYNAMIC_RESET_INCLUDE_PARTIALLY_OR_FULLY_ACTIVATED_GROUPS
					#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_DYNAMIC_RESET_PRECISE	//GIA3g1aTEMP52
				#endif
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_DYNAMIC_RESET_EXCLUDE_OF_NEWLY_ACTIVATED_COMPONENT_GROUP	//v1 GIA3g1eTEMP43
				//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SUPPORT_TRAILING_OPTIONAL_COMPONENTS_AND_SUBCOMPONENTS_DYNAMIC_RESET_EXCLUDE_OF_NEWLY_ACTIVATED_COMPONENT_GROUP_OLD2	//v2 GIA3g1g	//depreciated
			#else
				//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SOLIDIFY_NET_FORWARDPROP	//GIA3g1h (not used)	//reset all unconnected (partially) activated groups - a more comprehensive version of solidify backprop
			#endif
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SOLIDIFY_NET_BACKPROP	//GIA3g1aTEMP54
			#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SOLIDIFY_NET_BACKPROP
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SOLIDIFY_NET_BACKPROP_AFTER_ACTIVATING_INDIVIDUAL_COMPONENTS	//GIA3g1aTEMP35
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SOLIDIFY_NET_BACKPROP_BREAK_ALL_CONNECTIONS_TO_INACTIVE_GROUPS	//GIA3g1aTEMP57
			#endif
