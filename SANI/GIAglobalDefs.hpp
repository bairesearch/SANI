...
#define GIA_TXT_REL_TRANSLATOR	//GIA3
	...
	#define GIA_TXT_REL_TRANSLATOR_SANI	//GIA3g1a
#endif
...
//#define GIA_DEBUG_DISABLE_3k_CODE
	...
	#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR	//GIA3j2a
	#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR
	
		//debug variables (should all be disabled by default):		
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_SINGLE_POS_PERMUTATION
		
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA3  //detailed debug
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA4
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_FORMATION
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_BASIC
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TRACE
		
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION	//GIA3j5aTEMP53	//not required 	//should be activated for software verification
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_VERIFICATION	//not required	//should be activated for software verification	//can be disabled for specific debugging


		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS	//GIA3k1a
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_NUM_COMPONENTS (2)	//each neuron has to have exactly 2 seq components
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_IGNORE_PARTIAL_DETECTIONS	//only detect fully activated neurons
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_ELONGATED_TREE
			#ifndef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_ELONGATED_TREE
				#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE	//requires testing
			#endif
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_VERIFY_NO_CIRCULAR	//used for debugging (circular loops don't get generated by !GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS, or are generated much less often)
			//#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS	//not yet defined
				#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS	//GIA3k1b
				#ifndef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS
					#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_ENFORCE_FIRST_COMPONENT_NOT_MISSING	//GIA3k1a	//merge not supported		
				#endif
			//#endif
		#endif
	#endif
...
//#define GIA_DEBUG_DISABLE_3j_CODE
	...
	//#define GIA_TXT_REL_TRANSLATOR_SANI_SEMANTICALLY_DETERMINED_DYNAMIC_CONNECTIONS	//GIA3j1a	//incomplete

	//#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_OLD_BUG	//disabled GIA3j2aTEMP88

	//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR	//GIA3j2a
	#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR
		
		//untested variables (should all be disabled by default):
		//#define GIA_TXT_REL_TRANSLATOR_SANI_PROPAGATE_ALL_POS_VALUES_SIMULTANEOUSLY	//GIA3j4a	//untested
		
		//#define GIA_TXT_REL_TRANSLATOR_SANI_PREVENT_RECORDING_TOP_LEVEL_NEURON_IF_RECORDING_MAX_COVERAGE_NEURON	//GIA3j5a	//untested
		
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_OPTIONAL_AND_MULTIPLE_INPUTS	//reduces complexity (size) of generated network, but increases algorithm complexity (CHECKTHIS)
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_OPTIONAL_AND_MULTIPLE_INPUTS
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS	//GIA3j5a	//untested
			//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_DETECT_LOCAL_VARATION	//GIA3j3a	//untested
		#endif
		#ifndef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS
			//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ORIG	//this shouldnt ever be necessary, but restores code to precise GIA3j4a functional state
		#endif
		
		//debug variables (should all be disabled by default):		
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_SINGLE_POS_PERMUTATION
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_MAX_POS_PERMUTATIONS
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_MAX_POS_PERMUTATIONS
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_MAX_POS_PERMUTATIONS_NUM (5)
		#endif
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TEST_VERIFICATION_AFTER_GENERATION	//requires inputText to include a duplication of all sentences halfway through file
			
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG2
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG2
			#define GIA_DEBUG_TXT_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TRACE
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_BASIC
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_WORDCONNECTIVITY_VERIFICATION
			...
			//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
		#endif
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG	//temp
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG
			#define GIA_DEBUG_TXT_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TRACE
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_BASIC
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_WORDCONNECTIVITY_VERIFICATION
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_SPLIT
			//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_NEVER_SPLIT_GROUP_BETWEEN_TWO_IDENTICAL_COMPONENTS
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY
			//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TEST_VERIFICATION_AFTER_GENERATION	//requires inputText to include a duplication of all sentences halfway through file
			//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_TEST_VERIFICATION_PROPAGATION_IN_OPPOSITE_DIRECTION	//temp test only	//FAIL@GIA3j2aTEMP134, OK@GIA3j2j
			//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_SINGLE_POS_PERMUTATION
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_PRINT_GROUP_INDICES
			
			#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_DEBUG_WORDINDEX_VERIFICATION   //detailed debug
			#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA3  //detailed debug
			#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA4
			#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
		#endif
		...
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION	//GIA3j5aTEMP53	//not required 	//should be activated for software verification
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_VERIFICATION	//not required	//should be activated for software verification	//can be disabled for specific debugging
		#define GIA_TXT_REL_TRANSLATOR_SANI_SIMPLE_WORD_POS_TYPE_INPUT_ONLY


		#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_CENTRE_NEURONS
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ANN_CENTRE_NEURONS
			#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_CENTRE_NEURONS_X_AXIS
			#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_SEGREGATE_TOP_LAYER_NEURONS
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ANN_SEGREGATE_TOP_LAYER_NEURONS
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_SEGREGATE_TOP_LAYER_NEURONS_Y_SEPARATION (10)
			#endif
		#endif

		//algorithm tweaks:
		//#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//not yet defined
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_FORCE_RESET_IF_NO_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//GIA3j2bTEMP19	//mandatory
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY_BETWEEN_NEWLY_ACTIVATED_COMPONENT_AND_PREVIOUSLY_ACTIVATED_GROUP	//GIA3j2bTEMP21-24
				...
				//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY_BETWEEN_NEWLY_ACTIVATED_COMPONENT_AND_PREVIOUSLY_ACTIVATED_GROUP_INST	//GIA3j5aTEMP56
				#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY_BETWEEN_NEWLY_ACTIVATED_COMPONENT_AND_PREVIOUSLY_ACTIVATED_GROUP_OPTIMISED	//GIA3j2c
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY_BETWEEN_NEWLY_ACTIVATED_COMPONENT_AND_PREVIOUSLY_ACTIVATED_GROUP_OPTIMISED
					#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_ENSURE_PROSPECTIVE_WORD_CONNECTIVITY_BETWEEN_NEWLY_ACTIVATED_COMPONENT_AND_PREVIOUSLY_ACTIVATED_GROUP_OPTIMISED2	//GIA3j2c
				#endif
			#endif
		//#endif
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_NEVER_SPLIT_GROUP_BETWEEN_TWO_IDENTICAL_COMPONENTS	//added GIA3j2bTEMP8-TEMP9, updated GIA3j2bTEMP14-TEMP16	//this prevents algorithm issues involving repeated words (or sequences)
		#ifndef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_NEVER_SPLIT_GROUP_BETWEEN_TWO_IDENTICAL_COMPONENTS
			//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_WRITE_IF_UPPER_NEURON_ALREADY_CONTAINS_WORD_INDEX_OF_EXISTING_COMPONENT	//added GIA3j2aTEMP145, removed GIA3j2aTEMP8
		#endif
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_RESET_IF_NEXT_SEQUENCE_IS_SAME_AS_CURRENT_SEQUENCE	//GIA3j2aTEMP143
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_RESET_IF_FIRST_INACTIVE_COMPONENT_GROUPREF_IS_SAME_AS_FUTURE_ACTIVE_COMPONENT_GROUPREF	//GIA3j2aTEMP126, updated GIA3j2bTEMP18
			...
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_RESET_IF_FIRST_INACTIVE_COMPONENT_GROUPREF_IS_SAME_AS_FUTURE_ACTIVE_COMPONENT_GROUPREF_RECURSIVE	//GIA3j2aTEMP129 (never used?)
		#endif
		
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_WEIGHTS	//strengthen groups/componentConnections depending on usage
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_WEIGHTS
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_WEIGHTS_PRINT_COLOURS	//GIA3j2j
		#endif
		
		//#ifndef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//CHECKTHIS
		//#endif
		
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PREVENT_TOP_LEVEL_NEURON_DUPLICATION
		#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_DELAY_ANN_CONNECTIVITY_TILL_END
		
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_SUPPORT_PARTIAL_SENTENCE_PROPAGATION
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PERFORM_AUTORESET_OF_ACTIVATIONS		
		
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_SUPPORT_OPTIONAL_COMPONENTS	//not supported as groups may be split in the future, preventing propagation algorithm from functioning properly (NB propagation algorithm does not support optional components at "end" [ie lastIndex] of group)
		
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GROUP_TYPE_NAME "sequenceGrammarAutoGeneratedGroups"
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GROUP_TYPE_REFERENCE_SET_TYPE (3) //GIA_TXT_REL_TRANSLATOR_RULES_GROUPS_REFERENCE_SET_TYPE_SUBREFERENCESET "subReferenceSet"
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_GROUP_NAME "sequenceGrammarAutoGeneratedGroup"
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_NEURON_NAME "generated"
		
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET	//generates preliminary (non-functional) representation of sequence grammer network exclusively using ANNneuronClass rather than GIAtxtRelTranslatorRulesGroupClass:ANNneuronClass
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET
				...
				#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE
				...
				#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_ANN_DATAFILE_NAME "POStaggerOutputClassificationNetExperiencesDataFile.dat"
				#ifdef COMPILE_ANN
					...
					#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_ANN
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_ANN
						#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_ANN_EMULATE_EXACT_POS_TAGGER_DATABASE_OUTPUT	//relies on GIApreprocessorPOStaggerClass::generateANNexperienceFromPOSambiguityInfoPermutation from COMPILE_GIA_GENERATE_POS_TAGGER_DATABASE rather than GIAtxtRelTranslatorSANIPropagateCompactClass::propagateWordThroughNetworkIntro from GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_INTEGRATED
					#endif
				#endif
			#endif
			...
			//final version (non testing) 
			#ifdef COMPILE_GIA_GENERATE_POS_TAGGER_DATABASE	//ie GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE
				//execute GIAtxtRelTranslatorSANIPropagateCompactGenerate directly/immediately on wikidump POS tag derivations
				//assume compiled with COMPILE_GIA_WITH_ANN_GENERATE_POS_TAGGER_DATABASE
				...
				//assume compiled with COMPILE_GIA or COMPILE_GIA_WITH_ANN
					//ensure to compile GIAwithANN (activates USE_ANN: GIA_TXT_REL_TRANSLATOR_SANI_ANN) to print network
				#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_INTEGRATED
					//note supports GIA_TXT_REL_TRANSLATOR_SANI_PARSE/GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SAVE_PARSE_TREE
					//note doesn't support GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS/GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE/semantic network generation (GIAtranslator.parseNLPparserFileAndCreateSemanticNetworkBasedUponDependencyParsedSentences)
			#endif
		#endif	
		
		//see GIAtxtRelTranslatorSANIPropagateCompactClass::propagateWordThroughNetworkIntro: GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_AS_WILDCARDS is not supported, GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_AS_NOUNS is required
		
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_ORIG
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_ORIG
			//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2
				#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_NUMBER_COMPONENTS (2)	//this prevents the need to split neuronal components (biological feasibility)
				//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2_ADD_ALL_PERMUTATIONS	//add all 2-tuples in sequence (ie overlapping; start odd/0 and start even/1), else add first available/consecutive 2-tuples in sequence (start odd/0 only)
			#else
				#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_NUMBER_COMPONENTS (2)	//try 3, 4 etc
			#endif
		#endif
		#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS
			//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS_ENFORCE_DURING_SPLIT_OLD	//GIA3j2f
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_REQUIRE_NUM_COMPONENTS_ENFORCE_DURING_FIRST_HIDDEN_LAYER_GENERATION	//GIA3j2f	//requires GIA_TXT_REL_TRANSLATOR_SANI_ANN_DELAY_ANN_CONNECTIVITY_TILL_END
			#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MIN_NUM_COMPONENTS (2)	//each neuron has to have at least 2 components
		#endif
		//#define GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_MAX_NUMBER_LAYERS (200)	//adjust //~=GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE_RAW_SENTENCE_MAX_NUM_WORDS
		

		#define GIA_TXT_REL_TRANSLATOR_SANI_COMPACT
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_COMPACT

			#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_NEW

			#define GIA_TXT_REL_TRANSLATOR_SANI_REPLICATE_TOP_LEVEL_PARSE_TREE
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_REPLICATE_TOP_LEVEL_PARSE_TREE
				#define GIA_TXT_REL_TRANSLATOR_SANI_DONT_SET_NEURON_TRACED	//GIA3g11o	//experimental
				#define GIA_TXT_REL_TRANSLATOR_SANI_FREE_MEMORY	//GIA3g11p
			#endif
						
			#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
				#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT
					#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_SUM
				#endif
				#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_DYNAMIC
			#endif

			#define GIA_TXT_REL_TRANSLATOR_SANI_RESET_COMPONENT_NEURONCOMPONENTCONNECTIONACTIVEWORDRECORD
			
			#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
				#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION
					#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC
						#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT
							#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT_MUTUALLY_EXCLUSIVE
						#endif
					#endif
				#endif
			#endif
			#define GIA_TXT_REL_TRANSLATOR_SANI_REVERSE_DIRECTION	//mandatory //required to support recursion (parse sentences from right to left); eg (Tom said that (Mary said))

			#define GIA_TXT_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY	//GIA3h2a	//assume cannot backprop through parseTreeGroupNeuralNet
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY
				#define GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK0	//requires lastParseComponent->parseTreeGroupRef
				#define GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK1	//requires previousParseComponent->parseTreeGroupRef
				//#define GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK2	//store component's->parseTreeGroupRef for 1 layer
				//#define GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK3	//can backprop through groupNeuralNet but not parseTreeGroupNeuralNet
				
				#ifndef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_BIO	//GIA3i1a
				#endif
				//#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_BIO
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK0	//ie GIA_TXT_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY_WEAK
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK1
							//#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_DYNAMIC	//not yet defined
								#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_DYNAMIC_BIO	//GIA3i1a
								#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_DYNAMIC_BIO
									#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_WEIGHT_BIO	//GIA3i1a
								#endif
							//#endif
						#endif
					#endif
...
//#define GIA_DEBUG_DISABLE_3i_CODE
	...
	//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PRINT_FINAL
	//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PRINT_FINAL2
	...
	//#endif
		...
		//#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE	//not yet defined
			
			//#ifdef GIA_TXT_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//not yet defined
				#define GIA_TXT_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS_OR_OPTIONAL_REPEAT	//3i3b
			//#endif
			
			#ifndef GIA_TXT_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR
				#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PRELIM	//temp var for debug; must be set if GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED is set
			#endif
			//#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED	//not yet defined
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PRELIM
				#define GIA_TXT_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY	//GIA3h2a	//assume cannot backprop through parseTreeGroupNeuralNet
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY
					#define GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK0	//requires lastParseComponent->parseTreeGroupRef
					#define GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK1	//requires previousParseComponent->parseTreeGroupRef
					...
					//TODO: create a GIA_TXT_REL_TRANSLATOR_SANI_VERIFY_OWNER_GROUP_DOESNT_CONTAIN_NEWLY_ACTIVATED_COMPONENT_IN_ITS_PARSE_TREE_BIO method


					//TODO: create a GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_BIO method that works
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK1
						//#define GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_BIO_WEAK1	//GIA3i1a	//doesnt work
					#endif
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_BIO_WEAK3
						//define GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_BIO_WEAK3	//not yet coded	
					#endif
				#endif
			
				#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS	//GIA3i1a	//optional	//equivalent to old <GIA3g1i !GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SEPARATE
				
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC
						#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_OPTIMISED	//same speed as !GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS	//save optimum paths for every sentence once, and use this trace multiple times during GIA advanced referencing
						#ifndef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_OPTIMISED
							#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_UNOPTIMISED	//4x slower than !GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS	//unfinished (not yet implemented for USE_NLC:GIA_TXT_REL_TRANSLATOR_RULES_PARSE_ISOLATED_SUBREFERENCE_SETS)
							#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_UNOPTIMISED
								//#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_ONLY_PEFORM_PRELIM_PROPAGATION_IF_ADVANCED_REFERENCING
									...
									#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_OLD
								#endif		
							#endif
						#endif		
						#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_SET_WORD_POSTYPE_INFERRED_DYNAMIC_STREAMLINED	//mandatory
					#endif
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_DELETE_INCOMPLETE_PATHS_SEMANTIC_RELATIONS	//GIA3i1a
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSER	//GIA3g1c->GIA3g1h, GIA3i1a
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSER
						#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_BIO	//GIA3i1a	//currently mandatory (non bio implementation is not robust)	//parseTreeGroups are logically reducible to groups, parseTreeComponents are logically reducible to components [they just specify the parse relevant properties of the group/components]
						//#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_BIO_LIMIT_GENERATION_OF_SEM_NET_FROM_INCOMPLETE_PATHS	//trial GIA3i1aTEMP35
					#endif
				#endif
			#endif
			//#endif
			...
			#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE	//GIA3i1a	//equivalent to old <GIA3g1i GIA_TXT_REL_TRANSLATOR_SANI_PARSE	//required for performance calculations only (doesnt assume parse tree is generated or saved)
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS
				#ifndef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_BIO
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
				#endif
				#ifndef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_BIO
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
				#endif
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY_WEAK
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE	//requires previousParseComponent->parseTreeGroupRef
				#endif
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_DELETE_INCOMPLETE_PATHS_SEMANTIC_RELATIONS
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SAVE_PARSE_TREE	//this is required to set optimumPaths via backprop of final generated parse tree
				#endif
			#else
				#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
					#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SAVE_PARSE_TREE
				#endif
			#endif
		//#endif
	#else
...
//#define GIA_DEBUG_DISABLE_3h_CODE
				...
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN	//GIA3h3a
			#endif
				...
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES	//GIA3h3a	//reduces display x (width) - more compact	
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES
					#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES2	//GIA3h3b	//optional; no change in output
				#endif
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_SUPPORT_RECURSION	//where recursion prevents optimisation of display y coordinate of groupType, use its position within the xml file

				//#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_ADD_LAYER_FOR_EVERY_GROUP_TYPE	//GIA3g1a	//optional - not currently used

				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES
					#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_SPACING_X (5)
				#else
					#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_SPACING_X (100)	//max number of neurons per artificial groupType
				#endif
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_SPACING_Y (5)	//max number of layers in artificial groupType
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ANN_CALCULATE_BOUNDING_BOXES
					#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_SPACING_X (5)
				#else
					#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_SPACING_X (20)	//max number of neurons per groupType
				#endif
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_SPACING_Y (2)	//max number of layers in groupType
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_SPACING_X (1)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_SPACING_Y (1)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_SPACING_X (1)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_SPACING_Y (1)

				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_X (0)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_Y (0)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_X_WORDPOSTYPE (0)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_X_EXPLICITWORD (1)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_INPUT_POSITION_X_EXPLICITTOKENSLAYER (2)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_WORDPOSTYPE (0) 
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_WORDPOSTYPE_NOUN_VERB_VARIANTS (1)  				    
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITWORD (0)											    
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER (0)			    
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER_LAYER_CLASS_TYPE_INSTANCE (0)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER_LAYER_CLASS_TYPE (1)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER_LAYER_CLASS (2)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUP_ARTIFICIAL_INPUT_POSITION_Y_EXPLICITTOKENSLAYER_LAYER (3)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_SUBGROUP_ARTIFICIAL_SPACING_X (3)

				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_INPUT_POSITION_X (0)
				#define GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_INPUT_POSITION_Y (GIA_TXT_REL_TRANSLATOR_SANI_ANN_GROUPTYPE_ARTIFICIAL_SPACING_Y)
			#endif
		#endif
	#endif
#endif
...
//#define GIA_DEBUG_DISABLE_3g_CODE
	...
	#define GIA_TXT_REL_TRANSLATOR_SANI_COMPONENT_INDEX_FIRST (0)	//3g6a
	#ifdef GIA_TXT_REL_TRANSLATOR_SANI
	
		//light optimised debug only;		
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA9

		//light unoptimised debug only;
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA8
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA7
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA6
		
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA5
		
		//common debug;
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA4
			//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA3
			//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA2
			//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE_EXTRA
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_PROPAGATE
			//#define GIA_DEBUG_TXT_REL_TRANSLATOR_SANI_CREATE
		//#define GIA_DEBUG_TXT_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS_POS_TYPES
		
		#define GIA_TXT_REL_TRANSLATOR_SANI_WORD_INDEX_W_TO_ENTITY_INDEX_OFFSET (1)	//w starts at 0, sentence entityIndex starts at 1
	
		#define GIA_TXT_REL_TRANSLATOR_RULES_DEFINE_GROUP_TYPE_BACKUP_AT_START	//GIA3g1b
		#define GIA_TXT_REL_TRANSLATOR_RULES_DEFINE_WORD_TRANSLATOR_SENTENCE_ENTITY_INDEX_AT_START	//GIA3g1a	//required for GIA_TXT_REL_TRANSLATOR_SANI
		
		#define GIA_TXT_REL_TRANSLATOR_SANI_REPEAT_SEQUENCES_ENFORCE_CONSECUTIVE_STRING_COMPONENTS	//GIA3g1h

		#ifndef GIA_TXT_REL_TRANSLATOR_SANI_SIMPLE_WORD_POS_TYPE_INPUT_ONLY
			#define GIA_TXT_REL_TRANSLATOR_SANI_CREATE_NEURONS_FOR_NOUN_VERB_VARIANTS	//GIA3g1a
		#endif
		
		//#ifdef GIA_TXT_REL_TRANSLATOR_RULES_CODE_GROUP_PREVIOUS_WORD_POS_TYPE //not yet defined
			#define GIA_TXT_REL_TRANSLATOR_SANI_PREVIOUS_WORD_POS_TYPE_CHECKS	//GIA3g1a	//GIA3g1aTEMP61
		//endif
			
		#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE	//GIA3g1c
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE
			#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_RECORD_PERFORMANCE	//GIA3g1cTEMP14
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_RECORD_PERFORMANCE
				//#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_RECORD_PERFORMANCE_METHOD_OLD_INCREMENT_FOR_EVERY_GROUP_REF_RECURSE
			#endif	
		#endif
		#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE
			//#define GIA_TXT_REL_TRANSLATOR_SANI_PARSE_BASIC	//depreciated: modify and execute GIAtxtRelTranslatorParserClass::generateSemanticRelationsFromTxtRelations rather than adapting this code for GIAtxtRelTranslatorSANI
		#endif
		
		#ifndef GIA_TXT_REL_TRANSLATOR_SANI_PROPAGATE_ALL_POS_VALUES_SIMULTANEOUSLY
			#define GIA_TXT_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START	//GIA3g1aTEMP47	//GIA_TXT_REL_TRANSLATOR_SANI_PARSE does not currently robustly support GIA_TXT_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START
		#endif
		
		#ifndef GIA_TXT_REL_TRANSLATOR_SANI_COMPACT
			//#define GIA_TXT_REL_TRANSLATOR_SANI_HEAVY	//GIA3g6-9
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI_HEAVY
				//heavy: maintain multiple instances of the neural network in memory

				//#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_STRICT_ITERATION_INDICES	//created and disabled GIA3g9c

				#define GIA_TXT_REL_TRANSLATOR_SANI_SAVE_MEMORY_GROUPS	//GIA3g6a

				#define GIA_TXT_REL_TRANSLATOR_SANI_HEAVY_OPTIMISED	//GIA3g8-9
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_HEAVY_OPTIMISED

					#define GIA_TXT_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//optional: does not simplify algorithm

					#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE	//GIA3g8h	//required to emulation !GIA_TXT_REL_TRANSLATOR_SANI?
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE
						#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS	
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS
							//#ifdef USE_NLC	//remove this requirement in future (after GIA auto testing recompleted)
								#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
								#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
									#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT	//GIA3g9c
									#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT
										#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_SUM //3g10a	//requires testing
									#endif
								#endif
								#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_WEAK			//GIA3g9b
								#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_WEAK
									#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_WEAK_OFFSET (1)
								#endif
							//#endif
						#endif
					#endif

					#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY	//GIA3g8aTEMP51
					#define GIA_TXT_REL_TRANSLATOR_SANI_MAX_ITERATIONS (9)
					#define GIA_TXT_REL_TRANSLATOR_SANI_EFFICIENCY_STORE_POINT_ARRAY_IN_BASE_GROUP	//GIA3g8aTEMP28	

				#else
					#define GIA_TXT_REL_TRANSLATOR_SANI_HEAVY_UNOPTIMISED	//GIA3g6-7

					//#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT_OLD	//why was this never defined?

					#define GIA_TXT_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//optional: significantly simplifies algorithm

					#ifndef GIA_TXT_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS
						#define GIA_TXT_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS
							#define GIA_TXT_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS_METHOD2	//GIA3g6aTEMP54	//requires GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT
							//#define GIA_TXT_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS_METHOD1	//GIA3g6a, disabled GIA3g6aTEMP54
							#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS_METHOD1
								//#define GIA_TXT_REL_TRANSLATOR_SANI_SUPPORT_FUZZY_LAST_COMPONENTS_EFFICIENT	//GIA3g6aTEMP28, disabled GIA3g6aTEMP53 until debugged
							#endif
						#endif
					#endif

					#define GIA_TXT_REL_TRANSLATOR_SANI_SUPPORT_RECURSION	//GIA3g6a	//this is now mandatory (regardless of recursion, because group reset has been disabled)

					#define GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP		//GIA3g1aTEMP54	//GIA3g6a
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP
						#define GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP_AFTER_ACTIVATING_INDIVIDUAL_COMPONENTS	//GIA3g1aTEMP35	//GIA3g6a		
					#endif

					#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
						#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//GIA3g6aTEMP55	//make sure there is adjacent word connectivity between previous active components and newly activated component - ie no word indices are skipped
						#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD	//GIA3g6bTEMP4
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD
							#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD_NOUNS_ONLY
							#ifndef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD_NOUNS_ONLY
								#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_WORD_MULTIPLE_ACTIVATION_HYPOTHESES	//can perform pass through through multiple unactivated groups
							#endif
						#endif
						#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BASIC	//GIA3g1x		
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BASIC
							//#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BASIC_MAX_1_CONSECUTIVE_ISOLATED_WORDS	//GIA3g1x	//reactivated GIA3g6aTEMP58
							//#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BASIC_CONSECUTIVE_WORDS_SAME_POSTYPE	//GIA3g6aTEMP58
						#endif
						#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC	//GIA3g1b
					#endif 
				#endif

				//#define GIA_TXT_REL_TRANSLATOR_SANI_PREVENT_CIRCULAR_CONNECTION_LOOPS	//GIA3g1a	//temporarily enabled until determined due to parse these	//disabled GIA3g6a
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SAVE_MEMORY_GROUPS
					#define GIA_TXT_REL_TRANSLATOR_SANI_SAVE_MEMORY_GROUPS_PREVENT_CIRCULAR_CONNECTION_LOOPS	//added GIA3g6a
				#endif

			#else
				#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT	//GIA3g10a
				//light: only ever maintain a single instance of the neural network in memory
				#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT
					#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED		//GIA3g11a
					#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED 

						#define GIA_TXT_REL_TRANSLATOR_SANI_REPLICATE_TOP_LEVEL_PARSE_TREE	//GIA3g11f - required for GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_REPLICATE_TOP_LEVEL_PARSE_TREE
							#define GIA_TXT_REL_TRANSLATOR_SANI_DONT_SET_NEURON_TRACED	//GIA3g11o	//experimental
							#define GIA_TXT_REL_TRANSLATOR_SANI_FREE_MEMORY	//GIA3g11p
						#endif

						#define GIA_TXT_REL_TRANSLATOR_SANI_ADD_EXPLICIT_WORD_REFERENCES_AS_INDEPENDENT_POS_PERMUTATIONS	//GIA3g11m
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ADD_EXPLICIT_WORD_REFERENCES_AS_INDEPENDENT_POS_PERMUTATIONS
							#define GIA_TXT_REL_TRANSLATOR_SANI_ADD_EXPLICIT_WORD_REFERENCES_AS_INDEPENDENT_POS_PERMUTATIONS_EFFICIENT
						#endif

						#define GIA_TXT_REL_TRANSLATOR_SANI_VERIFY_OWNER_GROUP_DOESNT_CONTAIN_NEWLY_ACTIVATED_COMPONENT_IN_ITS_PARSE_TREE	//GIA3g11e

						#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_BASE
							#ifndef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_SIMULTANEOUS_BIO_LIMIT_GENERATION_OF_SEM_NET_FROM_INCOMPLETE_PATHS
								#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT	//GIA3g11cTEMP6
							#endif
							#ifdef GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT
								#define GIA_TXT_REL_TRANSLATOR_SANI_TAKE_LAST_SUCCESSFUL_PARSE_LIMIT_ITERATIONS_PREFERENCE_WEIGHT_SUM
							#endif
						...
						#endif
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_PARSE_GENERATE_PARSE_TREE	
							#define GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP		//GIA3g11j	//GIA3g1cTEMP4	//disabled GIA3g1cTEMP5
							#ifdef GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP
								#define GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP_AFTER_ACTIVATING_INDIVIDUAL_COMPONENTS	//GIA3g1cTEMP4	
								#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_SOLIDIFY	//preprocessor tag for GIAtxtRelTranslatorRules.xml
							#endif
						#endif

						#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS	//GIA3g11aTEMP57
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS
							#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_RESET	//GIA3g11aTEMP57
							#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS	//3g11aTEMP63
							#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS
								#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS_MOD	//GIA3g11i
								/*
								#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS_MOD
									#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_REFERENCESETS_THAT_CAPTURES_EOS_MOD2	//GIA3g11j
								#endif
								*/
							#endif
							//#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_PREPROCESS_DONT_OVERWRITE_COMPONENT_WHEN_NEW_COMPONENT_AVAILABLE	//GIA3g11aTEMP79	//disabled GIA3g11aTEMP81
						#endif

						#define GIA_TXT_REL_TRANSLATOR_SANI_RESET_COMPONENT_NEURONCOMPONENTCONNECTIONACTIVEWORDRECORD	//GIA3g11aTEMP46

						#define GIA_TXT_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//mandatory

						#define GIA_TXT_REL_TRANSLATOR_SANI_REVERSE_DIRECTION	//mandatory //required to support recursion (parse sentences from right to left); eg (Tom said that (Mary said))

						#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY
							#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC	//CHECKTHIS
							#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC
								#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT	//CHECKTHIS
								#ifdef GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT
									#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_POSHOC_STRICT_MUTUALLY_EXCLUSIVE	//GIA3g11g
								#endif
							#endif
							#define GIA_TXT_REL_TRANSLATOR_SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//CHECKTHIS
						#endif

						#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_NEW	//new code specific to GIA_TXT_REL_TRANSLATOR_SANI_LIGHT encapsulated for reference only

						#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS	//mandatory
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS
							#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS_TAKE_LAST_ACTIVATION_AS_PARSETREE	//mandatory (alternate method not implemented)
							#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS_VERIFY_MAX_NUMBER_OF_WORDS_IN_PARSETREE
							#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS_VERIFY_CONTAINS_EXISTING_WORDS_IN_PARSETREE	//GIA3g11aTEMP46
						#endif
						#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT	//mandatory
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT
							#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_ENSURE_FIRST_COMPONENT_ACTIVE_NEW	//added GIA3g11aTEMP70, GIA3g11aTEMP74
							#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESTORE
							#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_WORD		//rely on existingActivationFound instead
							#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_WORD
								#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_WORD_SUPPORT_RECURSION	//GIA3g11aTEMP37
								//#ifndef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_ALLOW_MULTIPLE_ACTIVATIONS_VERIFY_CONTAINS_EXISTING_WORDS_IN_PARSETREE
								#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_WORD_BASIC	//GIA3g11aTEMP44
								//#endif
							#endif
						#endif
					#else
						#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_UNOPTIMISED	//GIA3g10a

						#define GIA_TXT_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//mandatory

						#define GIA_TXT_REL_TRANSLATOR_SANI_REVERSE_DIRECTION	//required to support recursion (parse sentences from right to left); eg (Tom said that (Mary said))
						...
						//#define GIA_TXT_REL_TRANSLATOR_SANI_PREVENT_CIRCULAR_CONNECTION_LOOPS
						//#define GIA_TXT_REL_TRANSLATOR_SANI_SOLIDIFY_NET_BACKPROP	//TODO: work out if this requires reimplementation

						#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_NEW	//new code specific to GIA_TXT_REL_TRANSLATOR_SANI_LIGHT encapsulated for reference only
						#ifdef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_NEW
							#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_MEM
							#ifndef GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_MEM
								//perform restore of neuron activations based on their associated word index rather than local memory
								#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_BIO	//method without storing ownerGroupOrig in C++ memory
								//#define GIA_TXT_REL_TRANSLATOR_SANI_LIGHT_BIO2	//NOTYET CODED //determine method to restore using groupFrontComponentConnectionListIndex and numberOfWordsCurrentlyParsed
							#endif
						#endif
					#endif
				#endif
			...
			#define GIA_TXT_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS_ARTIFICIAL_GROUP_NAME_APPEND1 "ArtificialOptionalPermutationX1"
			#define GIA_TXT_REL_TRANSLATOR_SANI_REMOVE_LAST_OPTIONAL_COMPONENTS_ARTIFICIAL_GROUP_NAME_APPEND2 "ArtificialOptionalPermutationX2"
		#endif
...
//#define GIA_DEBUG_DISABLE_3f_CODE
	...
	#define GIA_PREPROCESSOR_WORD_NOUN_VARIANTS_PRIORITISE_IRREGULAR_PLURAL_FORM	//GIA3f5a 
		...
		#define GIA_TXT_REL_TRANSLATOR_RULES
			...
			#define GIA_TXT_REL_TRANSLATOR_RULES_INTERPRET_ALL_NON_PROPER_NOUNS_WITHOUT_DETERMINER_AS_CONCEPT_IE_NOT_JUST_PLURAL	//GIA3f10d	//this implementation has been taken from GIAsynRelTranslator
			...
			#ifdef GIA_TXT_REL_TRANSLATOR_SANI
				#define GIA_TXT_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START		//assume mandatory (definately required for GIA_TXT_REL_TRANSLATOR_SANI_PARSE_PERFORMANCE_RECORD_PERFORMANCE)
			#else
			...
			#define GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES	//precondition: all optional strings must have a known pos type to be processed (unknown not supported)
				...
				#ifndef GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_AS_WILDCARDS
					#define GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_AS_NOUNS
				#endif
				#define GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_MID_SENTENCE_CAPITALISED_WORDS_AS_PROPERNOUNS	//GIA3f10i
				#ifdef GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_MID_SENTENCE_CAPITALISED_WORDS_AS_PROPERNOUNS
					//#define GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_MID_SENTENCE_CAPITALISED_WORDS_AS_PROPERNOUNS_METHOD1
					#ifndef GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_MID_SENTENCE_CAPITALISED_WORDS_AS_PROPERNOUNS_METHOD1
						#ifndef GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_AS_WILDCARDS
							#define GIA_TXT_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_MID_SENTENCE_CAPITALISED_WORDS_AS_PROPERNOUNS_METHOD2
						#endif
					#endif
				#endif
			#endif
			
			#define GIA_TXT_REL_TRANSLATOR_RULES_RECORD_COMPONENT_PARSED_GROUP_REF_NAME_FOR_PRINT
			...
			#ifdef USE_NLC
				#define GIA_TXT_REL_TRANSLATOR_RULES_PARSE_ISOLATED_SUBREFERENCE_SETS	//GIA3f2l
				#ifdef GIA_TXT_REL_TRANSLATOR_RULES_PARSE_ISOLATED_SUBREFERENCE_SETS
					#ifdef USE_NLC
						#define GIA_TXT_REL_TRANSLATOR_RULES_PARSE_ISOLATED_SUBREFERENCE_SETS_OPTIMISED	//GIA3f4a
					#endif
				#endif
				#define GIA_TXT_REL_TRANSLATOR_RULES_INTERPRET_NUMBERS_AS_NOUNS
			#endif
			...
			#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_QUERIES	//GIA3f1t
			...
			#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_SEMANTIC_RELATION_RETURN_FUNCTION_NAME
				...
				#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_SEMANTIC_RELATION_RETURN_FUNCTION_NAME_SPECIAL_FUNCTION_TESTS	//GIA3f1t
				#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_SEMANTIC_RELATION_RETURN_FUNCTION_NAME_DYNAMIC_INDEX_TESTS	//GIA3f2l
			#endif 
			...
			#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_GROUP_PREVIOUS_WORD_POS_TYPE
				...
				#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_GROUP_EXISTS_PRECEEDING_WORD_POS_TYPE	//GIA3f2h	//note not strictly dependent on GIA_TXT_REL_TRANSLATOR_RULES_CODE_GROUP_PREVIOUS_WORD_POS_TYPE
			#endif
			#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_REPEAT
			#ifdef GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_REPEAT
				#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_REPEAT_IGNORE_CONSECUTIVE_PLURAL_NOUNS	//GIA3f2n
				#ifdef GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_REPEAT_IGNORE_CONSECUTIVE_PLURAL_NOUNS
					//#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_REPEAT_IGNORE_CONSECUTIVE_PLURAL_NOUNS_DETECT_IRREGULAR_NOUN_FORMS	//GIA3f5a optional
					#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_WORD_NOUN_VERB_VARIANT	//GIA3f2p
					#ifdef GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_WORD_NOUN_VERB_VARIANT
						#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_COMPONENT_WORD_NOUN_VERB_VARIANT_DETECT_IRREGULAR_NOUN_FORMS	//GIA3f5a
			...
			//#ifdef GIA_TRANSLATOR_NUMBER_OF	//not yet defined
				#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_NUMBER_OF	//GIA3f3d
			//#endif
			//#ifdef GIA_TRANSLATOR_EXPLETIVES	//not yet defined
				#define GIA_TXT_REL_TRANSLATOR_RULES_CODE_NUMBER_EXPLETIVES	//GIA3f7a
			//#endif
			GIA_TXT_REL_TRANSLATOR_RULES_CODE_NUMBER_EXPLETIVES
		#else
...
//#define GIA_DEBUG_DISABLE_3e_CODE
	...
	#define GIA_TXT_REL_TRANSLATOR_HYBRID_REFERENCE_SET_ADD_DUMMY_SUBJECT_AND_DUMMY_DELIMITER_DISABLE_CHANGES	//used until changes have been debugged	//GIA3e8d
	...
	#define GIA_TXT_REL_TRANSLATOR_HYBRID_DETERMINE_AMBIGUOUS_PREPOSITION_POS_TYPES_BASED_ON_CONTEXT	//GIA3e12a	//uses heuristics to verify preposition pos type - designed to replace the need for a more accurate pos tagger; GIA_TXT_REL_TRANSLATOR_HYBRID_EXECUTE_PRELIM_POS_TAGGER/GIA_PREPROCESSOR_POS_TAGGER
	...
	#define GIA_TXT_REL_TRANSLATOR_GRAMMATICALLY_STRICT_VERB_VARIANTS_ONLY	//GIA3e8b
	...
	//#define GIA_PREPROCESSOR_GRAMMATICALLY_STRICT_VERB_VARIANTS_ONLY	//disabled as higher level semantic processing of actions interprets all verb variants (regardless of whether they are grammatically strict verbs) as verbs
		...
		#define GIA_TXT_REL_TRANSLATOR_STORE_REFERENCE_SETS	//mandatory with GIA_TXT_REL_TRANSLATOR_HYBRID as hybrid uses reference sets
			...
			//#ifndef GIA_TXT_REL_TRANSLATOR_HYBRID_DETERMINE_AMBIGUOUS_PREPOSITION_POS_TYPES_BASED_ON_CONTEXT
				#define GIA_TXT_REL_TRANSLATOR_HYBRID_EXECUTE_PRELIM_POS_TAGGER	//GIA3e1a	//either uses third party NLP POS tagger or GIA pos tagger (GIA_PREPROCESSOR_POS_TAGGER)
			...
			#define GIA_TXT_REL_TRANSLATOR_HYBRID_NLC_PREPROCESSOR_PREFERENCE_NLP_PRELIM_POS_TAGS_OVER_LRP_WORD_TYPE_LISTS
		#endif
...
//#define GIA_DEBUG_DISABLE_3d_CODE
	...
	#define GIA_QUERY_SIMPLIFIED_SEARCH_ENFORCE_EXACT_MATCH_CONCEPTS	//GIA3d2a
		...
		//#define GIA_TXT_REL_TRANSLATOR_HYBRID_LOGIC_REFERENCE_PREPOSITIONS_MUST_SUCCEED_COMMA	//removed GIA3d5b
	#endif
	#define GIA_PREPROCESSOR_DERIVE_NOUN_VARIANTS
	#define GIA_TXT_REL_TRANSLATOR_HYBRID_REFERENCE_SET_SUPPORT_CONSECUTIVE_VERBS	//GIA3d5d
	//#define GIA_DEBUG_PREPROCESSOR_SENTENCE_RECONCILE_REFERENCES_DISABLE	//temp debug
		...
		#define GIA_TXT_REL_TRANSLATOR_HYBRID_REFERENCE_SET_ADD_DUMMY_SUBJECT_AND_DUMMY_DELIMITER_AND_OBJECT_FIRST_SUBREFERENCE_ONLY	//GIA3d5e
		#define GIA_TXT_REL_TRANSLATOR_HYBRID_REFERENCE_SET_ADD_DUMMY_SUBJECT_AND_DUMMY_DELIMITER_ONLY	//GIA3d5e
	#endif
	#ifdef GIA_TXT_REL_TRANSLATOR_HYBRID_REFERENCE_SET_DELIMITER_SPECIAL_CASE_DELIMITER_VERB_STATE_SUCCEEDED_BY_NOUN	//GIA3d8b
		#define GIA_TXT_REL_TRANSLATOR_HYBRID_REFERENCE_SET_DELIMITER_SPECIAL_CASE_DELIMITER_VERB_NOT_PRECEEDED_BY_THAT_WHICH_AND_NOT_PRECEEDED_BY_AUXILIARY_DETECT	//GIA3d5d
		...
		#define GIA_PREPROCESSOR_WORD_LOAD_WORD_LISTS
			...
			#define GIA_TXT_REL_TRANSLATOR_HYBRID_LOGIC_REFERENCE
				...
				#define GIA_TXT_REL_TRANSLATOR_HYBRID_LOGIC_CONJUNCTIONS_ALLOW_INTERMEDIARY_PREPOSITION_AND_VERB_LOGIC_REFERENCES
					...
					#define GIA_TXT_REL_TRANSLATOR_HYBRID_LOGIC_REFERENCE_CONJUNCTION_LR_WITH_EMBEDDED_PREPOSITION_VERB_LR	//GIA3a5i
				...
				#define GIA_TXT_REL_TRANSLATOR_HYBRID_LOGIC_REFERENCE_OUTPUT_LOGIC_REFERENCE_SETS_FOR_HIGH_LEVEL_SEMANTIC_PARSE	//GIA3a7a	//OLD: this is not required as the information is contained within GIAtxtRelTranslatorHybridLogicReference structure and it can be manually derived (without NLP)
