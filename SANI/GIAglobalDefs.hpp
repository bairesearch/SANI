...
//#define GIA_DEBUG_DISABLE_3g_CODE
		...
		//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_MIRROR_PARSE_HIERACHIES	//3g1d?	//alternative implementation that saves parsed neural net in separate data structure
		...
		//#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY	//3g1b
			...
			#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_WEAK
				...
				#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY_WEAK_MIN_NUMBER_OF_RECENCY_GRADATIONS (2)
			#endif
		#endif
		#define GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_DO_NOT_SET_SUBCOMPONENT_ACTIVATION_UNLESS_SET_COMPONENT_ACTIVATION	//3g1b - more consistent behaviour (required by GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY)
		...
		#define GIA_TXT_REL_TRANSLATOR_RULES_DEFINE_GROUP_TYPE_BACKUP_AT_START	//3g1b	//required for GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_PREFERENCE_MOST_RECENT_ACTIVATED_PATHWAY
