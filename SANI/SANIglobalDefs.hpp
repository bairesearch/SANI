...
//#define SANI_DEBUG_DISABLE_1g_CODE
	...
	#define SANI_COMPONENT_INDEX_FIRST (0)	//3g6a
		...
		#ifdef SANI_PROPAGATE_ALL_POS_VALUES_SIMULTANEOUSLY	//added SANI1m1a
			#define SANI_POS_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START_DISABLE	//added SANI1m1a
		#endif
