...
//#define SANI_DEBUG_DISABLE_1p_CODE
	...
	//#define DEBUG_SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY
			...
			#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION
				...
				#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_VIA_DETERMINERS	//SANI1p1a - perform SANI reference set identification via new method
					...
					#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE
						...
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_ACTIVATED_USE	//fully activated neurons are preferred	//!missing
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_ACTIVATION_SEQUENTIALITY_USE	//neurons with components activated sequentially (in order) are preferred
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_WORDS_CAPTURED_USE	//neurons with components containing words in order and contiguous are preferred
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_WORDS_SEQUENTIALITY_USE	//neurons with components containing words in order and contiguous are preferred
						//#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_NEURON_POPULARITY_USE		//most popular/used neurons are preferred	//requires testing/tuning
						//#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_RECENCY_USE	//recently activated neurons are preferred	//requires testing/tuning

						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_ACTIVATED (1.0)	
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_ACTIVATION_SEQUENTIALITY (0.5)	
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_WORDS_CAPTURED (1.0)	
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_WORDS_SEQUENTIALITY (0.5)	
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_NEURON_POPULARITY (1.0)	
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_PENALTY_COMPONENTS_RECENCY (1.0)	
