...
#define SANI_PRINT_EXECUTION_TIME	//disable this while performing incremental automated testing
	...
	#define SANI_NODES	//identified SANI1m3b
		...
		#define SANI_SEQUENCE_GRAMMAR	//SANI1j2a
			...
			#define SANI_SEQUENCE_GRAMMAR_INPUT_NLP	//SANI1j2a (default)
			//#define SANI_SEQUENCE_GRAMMAR_INPUT_IMAGEDATA	//SANI1q2a	//note subset of SANI_SEQUENCE_GRAMMAR is design/implementation artefact
			//#define SANI_SEQUENCE_GRAMMAR_INPUT_CONTINUOUSDATA	//SANI1q2a	//note subset of SANI_SEQUENCE_GRAMMAR is design/implementation artefact
			#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_NLP
				#define SANI_SEMANTIC_NETWORK	//SANI1m1a	//store semantic network within SANI parse tree rather than generating from SANI parse tree - SANI input sequenceElements rather than pos
				...
				#endif
			#elif defined SANI_SEQUENCE_GRAMMAR_INPUT_IMAGEDATA
				#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
				#define SANI_SEQUENCE_GRAMMAR_VARIABLE_COMPONENTS
			#elif defined SANI_SEQUENCE_GRAMMAR_INPUT_CONTINUOUSDATA
				#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
				#define SANI_SEQUENCE_GRAMMAR_VARIABLE_COMPONENTS
			#endif	
		#endif
...
//#define SANI_DEBUG_DISABLE_1q_CODE
#ifndef SANI_DEBUG_DISABLE_1q_CODE
	
	#ifdef SANI_SEQUENCE_GRAMMAR
	
		//uncoded cases introduced @SANI1q2a;
		#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_IMAGEDATA
		
		#endif
		#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_CONTINUOUSDATA
		
		#endif		
		
		#ifdef SANI_SEQUENCE_GRAMMAR_VARIABLE_COMPONENTS
			#ifdef SANI_SEMANTIC_NETWORK	//optional
				//#define SANI_SEQUENCE_GRAMMAR_VARIABLE_COMPONENTS_OVERLOAD	//SANI1q1a - do not assign a top level neuron for every sentence (sequenceElements/POS)
				#ifdef SANI_SEQUENCE_GRAMMAR_VARIABLE_COMPONENTS_OVERLOAD
					#define SANI_SEQUENCE_GRAMMAR_PARSE_TREE_EXTEND
				#endif
			#endif
		#endif
		#define SANI_SEQUENCE_GRAMMAR_PARSE_TREE_EXTEND	//separated SANI1q1c
		#ifdef SANI_SEQUENCE_GRAMMAR_PARSE_TREE_EXTEND
			#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_DUPLICATE_DETECTION_CULL	//SANI1q1a
			#define SANI_SEQUENCE_GRAMMAR_PARSE_TREE_SAVE_LEAF_NODES		//save leaf nodes (input neurons) in parse tree
			#ifdef SANI_SEQUENCE_GRAMMAR_PARSE_TREE_SAVE_LEAF_NODES
				//#define DEBUG_SANI_SEQUENCE_GRAMMAR_PARSE_TREE_SAVE_LEAF_NODES	//tests whether currentParseTreeGroupTemp object has been generated
			#endif
			#define SANI_SEQUENCE_GRAMMAR_SUPPORT_VARIABLE_COMPONENTS_STRING_OR_GROUP	//SANI1n3a, activated SANI1q1a
			#ifdef SANI_SEQUENCE_GRAMMAR_SUPPORT_VARIABLE_COMPONENTS_STRING_OR_GROUP
				#define SANI_SEQUENCE_GRAMMAR_SUPPORT_VARIABLE_COMPONENTS_STRING	//SANI1n3b, activated SANI1q1a	//incomplete	//enables SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_FIRST_COMPONENTS_NON_STRING/SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_LAST_COMPONENTS_NON_STRING [or SANI_SEQUENCE_GRAMMAR_COMPONENT_GENERATE_VARIABLE_FIRST_COMPONENTS_NON_STRING/SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_GENERATE_VARIABLE_LAST_COMPONENTS_NON_STRING]
			#endif
		#endif
	#endif
...
//#define SANI_DEBUG_DISABLE_1p_CODE
		...
		//#define SANI_DEBUG_PROPAGATE_EXTRA2_REFSETS
		...
		#define SANI_PARSE_RECORD_COMPONENT_SEQUENCE_INDEX	//SANI1p3a	//note this does not require full SANI_PARSE_GENERATE_PARSE_TREE functionality (ie is ~compatible with SANI_PARSE_PERFORMANCE_BIO) as primarily only interested in recording/accessing the sequenceElement index of leaf nodes
		...
		//#endif
			...
			#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS	//SANI1p9a	//requires SANI_SEQUENCE_GRAMMAR_DETERMINE_POS_AMIGUITY_INFO_AT_START
				...
				#define SANI_POS_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START_DISABLE
					
				#define SANI_SEQUENCE_GRAMMAR_PARSE_TREE_SAVE_LEAF_NODES		//SANI1p9a	//save leaf nodes (input neurons) in parse tree
				#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_MARK_AS_UNAMBIGUOUS	//SANI1p9a 	//mark ambiguous inputs as unambigous if they are successfully parsed by an unambiguous/unique POS input
				#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_MARK_AS_UNAMBIGUOUS
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_MARK_AS_UNAMBIGUOUS_VERIFY_POS_UNAMBIGUOUS_WORDS	//SANI1p9a -  pos ambiguous components nodes are resolved when they are parsed with a non-ambiguous sequenceElement
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_MARK_AS_UNAMBIGUOUS_VERIFY_UNIQUE	//SANI1p9a - pos ambiguous components nodes are resolved when 1 pos value is possible by the component based on the sentence sequenceElement pos values	//optional
				#endif
				#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED	//SANI1p10a	- allow pos ambiguous input subsentences to be matched to existing subnets
				#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_SIMULTANEOUSLY_PROPAGATE_UNAMBIGUOUS_POS_PERMUTATIONS	//required
					#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_SIMULTANEOUSLY_PROPAGATE_UNAMBIGUOUS_POS_PERMUTATIONS
						#define SANI_PROPAGATE_ALL_POS_VALUES_SIMULTANEOUSLY
					#endif
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_VERIFY 	//SANI1p10a	//pos ambiguous input sentence sequenceElements can only be matched to pos unambiguous subnet/unique POS input
					#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_VERIFY
						#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_VERIFY_POS_UNAMBIGUOUS_SUBNET
						#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_VERIFY_UNIQUE	//optional
						//#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_MARK_AS_UNAMBIGUOUS	//optional	//appropriately verified matched subnets will be marked as unambiguous
					#endif
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_REQUIRE_POS_UNAMBIGUOUS_CONTEXT
					#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_REQUIRE_POS_UNAMBIGUOUS_CONTEXT
						#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_REQUIRE_POS_UNAMBIGUOUS_CONTEXT_BOUNDARY (2)	//pos ambiguous [consecutive?] sequenceElements must be bounded x pos unambiguous sequenceElements	
						#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_REQUIRE_POS_UNAMBIGUOUS_CONTEXT_IGNORE_OUT_OF_SENTENCE_BOUNDS	//context requirement is currently ignored for out of sentence bounds
					#endif
				#else
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START
				#endif
			#endif
			...
			//#define SANI_PROPAGATE_ALL_POS_VALUES_SIMULTANEOUSLY_INDEPENDENT	//optional //independent trial @SANI1p8a, 1p11a
			#ifdef SANI_PROPAGATE_ALL_POS_VALUES_SIMULTANEOUSLY_INDEPENDENT
				#define SANI_PROPAGATE_ALL_POS_VALUES_SIMULTANEOUSLY
			#endif
			
			#ifdef SANI_PROPAGATE_ALL_POS_VALUES_SIMULTANEOUSLY
				#ifndef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY	//added condition SANI1p11aTEMP22
					...
					#define SANI_PROPAGATE_ALL_POS_VALUES_SIMULTANEOUSLY_VERIFY_PREVIOUS_COMPONENT_NOT_ACTIVATED_BY_SAME_WORD_DIFFERENT_POS_PROPAGATION	//added SANI1j
				#endif
				//#ifdef SANI_SEQUENCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFICATION	//not yet defined
					#define SANI_SEQUENCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFICATION_DO_NOT_STOP	//SANI1p10c
					#define SANI_SEQUENCE_GRAMMAR_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT_AFTER_SIMULTANEOUS_POS_PROPAGATION	//optional SANI1p7a - enhances biological plausability of SANI propagation algorithm (performs sequenceElement index contiguity verification of final generated parse trees at end of forward propagation)
					#ifdef SANI_SEQUENCE_GRAMMAR_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT_AFTER_SIMULTANEOUS_POS_PROPAGATION	
						#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT
						#ifdef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT
							#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT_MUTUALLY_EXCLUSIVE
						#endif
					#endif
				//#endif
			#endif
			...
			//#define SANI_SEQUENCE_GRAMMAR_LINK_SIMILAR_SUBNETS
					...
					#define SANI_SEQUENCE_GRAMMAR_DISALLOW_DIRECT_REFSET_AND_DELIMITER_POS_COMPONENTS_ON_SAME_NEURON	//SANI1p6a	//only currently implemented for SANIgenerateCompactContinuous
							...
							//#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_WORDS	//not yet defined
								#define SANI_SEQUENCE_GRAMMAR_STORE_SEQUENCEELEMENT_OBJECTS
										...
										#define SANI_SEQUENCE_GRAMMAR_STORE_SEQUENCEELEMENT_OBJECTS_CALCULATE_POS_AMBIGUITY_INFO
									#endif
								#endif
							//#endif
						#endif
				...
				//#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_WORDS	//not yet defined
					#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION
						...
						#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY	//reference set identification performed during identification stage 

						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_VIA_DETERMINERS	//SANI1p1a - perform SANI reference set identification via new method	//requires further testing
						#ifdef SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_VIA_DETERMINERS

							//requires to be compiled with ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_NLP

							#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_VIA_DETERMINERS_SUPPORT_PRONOUNS	//SANI1p5a	//requires SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_UNAMBIGUOUS_ENTITIES_PRONOUNS
							#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_VIA_DETERMINERS_SUPPORT_PREDETERMINERS	//SANI1p4a
							#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_VIA_DETERMINERS_SUPPORT_CONCEPTS	//SANI1p1a-SANI1p4a
							#ifdef SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_VIA_DETERMINERS_SUPPORT_CONCEPTS
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_CONCEPTS
							#endif
							//#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_VIA_DETERMINERS_SUPPORT_PROPERNOUNS	//SANI1p1a	//propernouns are not determiners (reference sets do not follow propernouns)

							#define SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_POS	//SANI1p3a	//requires SANI_ANN_DELAY_ANN_CONNECTIVITY_TILL_END
							#ifdef SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_POS

								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_REFSET_DELIMITER_CONNECTIONS
								#ifdef SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_REFSET_DELIMITER_CONNECTIONS
									/*
									#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_REFSET_DELIMITER_CONNECTIONS_TYPE_UNKNOWN (LRP_SHARED_ENTITY_CONNECTION_TYPE_UNDEFINED)
									#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_REFSET_DELIMITER_CONNECTIONS_TYPE_REFSET_NORMAL (LRP_SHARED_ENTITY_CONNECTION_TYPE_SAMEREFERENCESET)
									#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_REFSET_DELIMITER_CONNECTIONS_TYPE_REFSET_DELIMITER (LRP_SHARED_ENTITY_CONNECTION_TYPE_DIFFREFERENCESET)
									*/
								#endif
							#endif

							#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_UNAMBIGUOUS_ENTITIES	//SANI1p2a
							#ifdef SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_UNAMBIGUOUS_ENTITIES
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_OF_REFERENCE_SET_DELIMITERS	//SANI1p2a
								//#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_AMBIGUOUS_ENTITIES	//also markate entities with pos ambiguous info
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_UNAMBIGUOUS_ENTITIES_AUXILIARIES	//SANI1p4a
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_UNAMBIGUOUS_ENTITIES_CONJUNCTIONS	//SANI1p5a
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_UNAMBIGUOUS_ENTITIES_PRONOUNS	//SANI1p5a
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_UNAMBIGUOUS_ENTITIES_PROPERNOUNS	//SANI1p5a

								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_DEMARKATE_POS_UNAMBIGUOUS_ENTITIES_ENFORCE_SINGLE_UNIQUE_DIRECT_INPUT	//SANI1p5a
							#endif

							#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE
							#ifdef SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE

								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_IGNORE_DETERMINER

								#ifdef DEBUG_SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_WEAK
									#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_MINIMUM_ACTIVATION_SIGNAL (1.0)
								#else
									#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_MINIMUM_ACTIVATION_SIGNAL (2.0) //apply minimum activation signal for reference set identification	//SANI1p1d
								#endif

								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_IGNORE_EOS	//FULLSTOP	//SANI1p1d

								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_START_CODON_UNKNOWN (0)
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_START_CODON_DEFINITE (1)
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_START_CODON_INDEFINITE (2)
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_START_CODON_CONCEPT_SUBJECT_OR_OBJECT (3)
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_START_CODON_CONCEPT_SUBJECT (4)
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_START_CODON_CONCEPT_OBJECT (5)
								//#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_START_CODON_PROPERNOUN (6)

								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_ACTIVATED_USE	//fully activated neurons are preferred	//!missing
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_ACTIVATION_SEQUENTIALITY_USE	//neurons with components activated sequentially (in order) are preferred
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_WORDS_CAPTURED_USE	//neurons with components containing sequenceElements in order and contiguous are preferred
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_WORDS_SEQUENTIALITY_USE	//neurons with components containing sequenceElements in order and contiguous are preferred
								//#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_NEURON_POPULARITY_USE		//most popular/used neurons are preferred	//requires testing/tuning
								//#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_RECENCY_USE	//recently activated neurons are preferred	//requires testing/tuning

								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_ACTIVATED (1.0)	
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_ACTIVATION_SEQUENTIALITY (0.5)	
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_WORDS_CAPTURED (1.0)	
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_WORDS_SEQUENTIALITY (0.5)	
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_NEURON_POPULARITY (1.0)	
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_RECENCY (1.0)	

								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_INPUT_SIGNAL (1.0)	//input signal of each sequenceElement is set to 1.0

								#ifdef SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_NEURON_POPULARITY_USE
									//#assert SANI_SEQUENCE_GRAMMAR_WEIGHTS	//required for neuron popularity calculations
								#endif
								#ifdef SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_RECENCY_USE
									#define SANI_SEQUENCE_GRAMMAR_STORE_RECENCY	//assert SANI_SEQUENCE_GRAMMAR_STORE_RECENCY_UPDATE_SUCCESSFULLY_PARSED_NEURONS_BEFORE_REFERENCE_SET_IDENTIFICATION	//required for neuron recency calculations
								#endif

								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_STRENGTH_MAX_SIGNIFICANT_FIGURES (3)
							#endif
						#endif
					#endif
				//#endif
		...
		//#define SANI_SEQUENCE_GRAMMAR_PARSE_TREE_SAVE_LEAF_NODES	//temp independent test @SANI1p9a
		#ifdef SANI_SEQUENCE_GRAMMAR_PARSE_TREE_SAVE_LEAF_NODES
			#define SANI_SEQUENCE_GRAMMAR_PARSE_TREE_SAVE_LEAF_NODES_COMPATIBILITY
			#define SANI_SEQUENCE_GRAMMAR_PARSE_TREE_SAVE_LEAF_NODES_ADD_INPUT_NEURONS_TO_GROUPTYPES_ARRAY	//currently required such that parseTree groups are automatically created for input neurons //verify that this does not have any unexpected consequences
			#ifdef SANI_SEQUENCE_GRAMMAR_PARSE_TREE_SAVE_LEAF_NODES_ADD_INPUT_NEURONS_TO_GROUPTYPES_ARRAY		
				#define SANI_SEQUENCE_GRAMMAR_GROUP_TYPE_INPUT_NEURONS_NAME "sequenceGrammarAutoGeneratedGroupsInputNeurons"
			#endif
		#endif
					
		//#ifndef SANI_SEQUENCE_GRAMMAR_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT_AFTER_SIMULTANEOUS_POS_PROPAGATION
			#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT
		//#endif
	#endif
#endif
...
//#define SANI_DEBUG_DISABLE_1o_CODE
#ifndef SANI_DEBUG_DISABLE_1o_CODE
...
//#define SANI_DEBUG_DISABLE_1n_CODE
	...
	//#ifdef SANI_SEQUENCE_GRAMMAR_STORE_SENTENCE_INDEXING	//not yet defined
		#ifndef SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_POS
	...
	//#endif
		...
		#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_DISALLOW_IDENTICAL_INPUTS	//SANI1n6b
			...
			#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY	//enforced @SANI1n6a
		#endif
		
		//#ifdef SANI_SEQUENCE_GRAMMAR_GENERATE_SUBNETS_BASED_ON_POS_UNAMBIGUOUS_SEGMENTS or SANI_POS_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START
	...
	//#define SANI_SEQUENCE_GRAMMAR_GENERATE_SUBNETS_BASED_ON_POS_UNAMBIGUOUS_SEGMENTS	//SANI1n5c	//inactive
		...
		#ifdef SANI_SEQUENCE_GRAMMAR_VARIABLE_COMPONENTS	//CHECKTHIS (added SANI1q1a)
	...
	#ifdef SANI_SEQUENCE_GRAMMAR
		//#define SANI_SEQUENCE_GRAMMAR_VARIABLE_COMPONENTS	//SANI1j-1n	//now configured at top	
		#ifdef SANI_SEQUENCE_GRAMMAR_VARIABLE_COMPONENTS
			//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_GENERATE_VARIABLE_COMPONENTS	//SANI1j-1m (generates variable first/last components when generating network)
				...
				#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
					#define SANI_SEQUENCE_GRAMMAR_GENERATE_INCREMENTALLY_SECTIONED	//explicated SANI1o1a
					...
					#define SANI_SEQUENCE_GRAMMAR_COMPONENT_GENERATE_VARIABLE_FIRST_COMPONENTS	//SANI1j5a	//optional
					#ifdef SANI_SEQUENCE_GRAMMAR_COMPONENT_GENERATE_VARIABLE_FIRST_COMPONENTS
						#define SANI_SEQUENCE_GRAMMAR_COMPONENT_GENERATE_VARIABLE_FIRST_COMPONENTS_CLEAN_PARSE_TREE_MEMORY	//SANI1n9b
						#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_SHARED
					#endif
				#endif
			#else
		...
		#else
			#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
				//#define SANI_SEQUENCE_GRAMMAR_GENERATE_INCREMENTALLY_SECTIONED	//explicated SANI1o1a	//optional - reenabled @SANI1p1b to support symmetrical network generation
			#endif
		#endif
		#ifndef SANI_SEQUENCE_GRAMMAR_GENERATE_INCREMENTALLY_SECTIONED
			#define SANI_SEQUENCE_GRAMMAR_GENERATE_CONTINUOUS	//explicated SANI1o1a
		#endif
	#endif
		...
		#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_DETECTED_EDGE_OF_SENTENCE	//SANI1n1a
			...
			//#ifndef SANI_SEMANTIC_NETWORK	//CONSIDER @SANI1q1a
			//#ifndef SANI_SEQUENCE_GRAMMAR_SUPPORT_VARIABLE_COMPONENTS_STRING	//CONSIDER @SANI1q1a
			#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_VERIFY_THAT_VARIABLE_EDGE_COMPONENT_SOURCE_POS_IS_NOT_IDENTICAL	//SANI1n8a
			//#endif
			//#endif
...
//#define SANI_DEBUG_DISABLE_1m_CODE
	...
	//#define SANI_SUPPORT_SEQUENTIAL_NET_XML_IO	//uncoded
	...
	#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_NLP	//condition added SANI1q2a
		...
		#ifdef SANI_SEMANTIC_NETWORK
			#define SANI_SEQUENCE_GRAMMAR_INPUT_WORDS	//SANI1m1a	//input sequenceElements rather than pos values into SANI
			#ifdef SANI_SEQUENCE_GRAMMAR_INPUT_WORDS
				#define SANI_SEQUENCE_GRAMMAR_INPUT_DYNAMIC	//explicated SANI1p9a	//dynamically generate input neurons based on content (sequenceElements)
				#define SANI_POS_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START_DISABLE	//SANI1m1a
				#define SANI_SEQUENCE_GRAMMAR_INPUT_WORDS_LEMMAS	//optional (feed lemmas rather than exact sequenceElements)
			#endif
		#else
			#define SANI_SEQUENCE_GRAMMAR_INPUT_POS	//explicated SANI1p9a
		#endif
	#endif
...
//#define SANI_DEBUG_DISABLE_1l_CODE
	...
	#define SANI_SEQUENCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFICATION	//SANI1j5aTEMP53	//not required 	//should be activated for software verification
			...
			#define SANI_DEBUG_SEQUENCE_GRAMMAR_WORDCONNECTIVITY_VERIFICATION_CONTINUOUS	//SANI1j15a //continuous verification of SANI_SEQUENCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFICATION
		#endif
	#endif
			...
			//#ifdef SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE	//not yet defined (generation code implementation has not yet been derived for ELONGATED_TREE)
					...
					#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_GENERATE_VARIABLE_LAST_COMPONENTS	//SANI1l6b	
						...
						//#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_RESET_IF_REPEATED_SEQUENCE_DETECTED	//not yet defined
							#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_RESET_IF_REPEATED_SEQUENCE_DETECTED_AND_SEQUENCE_INDEX_NOT_ALREADY_ENCAPSULATED_BY_HIGHER_LEVEL_GROUP_PREVIOUS_COMPONENT
						//#endif
						...
						//#ifdef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_PRECHECKS	//not yet defined
							#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_PRECHECKS2	//SANI1l6c
						//#endif
					...
					#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS
                			...
                			#define SANI_SEQUENCE_GRAMMAR_SUPPORT_VARIABLE_LAST_COMPONENTS_REMEMBER_FIRST_COMPONENT_SEQUENCE_INDEX	//SANI1l7a	//see SANI_ALLOW_MULTIPLE_ACTIVATIONS
                                        #ifdef SANI_SEQUENCE_GRAMMAR_SUPPORT_VARIABLE_LAST_COMPONENTS_REMEMBER_FIRST_COMPONENT_SEQUENCE_INDEX
						//#assert SANI_PARSE_SAVE_PARSE_TREE	//note SANI1l7b implementation currently requires memory of parseComponent->neuronComponentConnectionActiveSequenceElementRecord and parseComponent->parseTreeGroupRef such that the last components can be replaced/overwritten if necessary	//incompatible with principle/intent of SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY?
					#endif
				#endif
			//#endif
		//#endif
...
//#define SANI_DEBUG_DISABLE_1k_CODE
		...
		//#define SANI_DEBUG_SEQUENCE_GRAMMAR_UPDATE_ACTIVATED_NEURON_WITH_MAX_SEQUENCE_INDEX_COVERAGE
		//#define SANI_DEBUG_PROPAGATE_EXTRA3  //detailed debug
		...
		#ifndef SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS
		...
		*/
		...
		//#define SANI_SEQUENCE_GRAMMAR_PREVENT_RESET_IF_FIRST_INACTIVE_COMPONENT_GROUPREF_IS_SAME_AS_FUTURE_ACTIVE_COMPONENT_GROUPREF_AND_SATISIFIES_SEQUENCE_INDEX	//SANI1k4a, disabled SANI1k7a, depreciated SANI1n1a
			
		//#define SANI_SEQUENCE_GRAMMAR_EXECUTE_WORD_CONNECTIVITY_TESTS_ONCE //execute sequentialActivationConnectivityTests at start to save multiple executions	//SANI1k11b	//mandatory SANI1k13a with SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY upgrade
		...
		//#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS	//SANI1k1a	//now configured at top
		#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
			
			#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_PRECHECKS	//made optional SANI1k17b
			...
			//#ifdef SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_ELONGATED_TREE	//condition added SANI1k15g //condition removed SANI1k15h - REDUNDANT_WORD_CONNECTIVITY_CHECK are not required with SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY
			...
			#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_RESET_IF_REPEATED_SEQUENCE_DETECTED	//SANI1k7a
				...
				//#ifdef SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE
					//#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_PREVENT_ACTIVATION_IF_REPEATED_SEQUENCE_MISMATCH_DETECTED	//SANI1k15c	//disabled SANI1k16a (not required with SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY)
				//#endif
			#endif
			...
			#define SANI_SEQUENCE_GRAMMAR_VERIFY_NO_CIRCULAR	//used for debugging (circular loops don't get generated by !SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS, or are generated much less often)
				...
				#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_GENERATE_VARIABLE_FIRST_COMPONENTS	//SANI1k1b
					...
					//#ifdef SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//not yet defined
						...
						//#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENT_ALL_NEURONS_IN_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE		//SANI1k12a trial only	//enabled SANI1n6c, disabled SANI1n7c
					...
					//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_GENERATE_VARIABLE_FIRST_COMPONENTS_PRELIM_TEST	//SANI1k3a+	//not yet complete - requires definition of function copyRuleGroupType	//remove depreciated SANI1o1a
				...
				//#define SANI_SEQUENCE_GRAMMAR_GENERATE_INCREMENTALLY_SECTIONED	//SANI1k9a	//only currently supported by SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS	//moved to top SANI1o1a

				#ifdef SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE
					#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT_MEMORY	//SANI1k10a	//updated SANI1k13a	//activated SANI1k15h
				#endif
				...
				#define SANI_SEQUENCE_GRAMMAR_OPTIMISE_FOR_DIVERGENT_CONVERGENT_PATHWAYS	//SANI1k5a
			#endif
	...
	//#define SANI_SEQUENCE_GRAMMAR	//SANI1j2a
		...
		*/
		...
		//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_GENERATE_VARIABLE_FIRST_COMPONENTS	//SANI1j5a
			...
			//#define SANI_SEQUENCE_GRAMMAR_ORIG	//this shouldnt ever be necessary, but restores code to precise SANI1j4a functional state	//remove depreciated SANI1o1a
		#endif
		...
		//#define SANI_DEBUG_SEQUENCE_GRAMMAR	//temp
			...
			#define SANI_DEBUG_PROPAGATE
			#define SANI_DEBUG_SEQUENCE_GRAMMAR_SEQUENCEINDEX_VERIFICATION   //detailed debug
			#define SANI_DEBUG_PROPAGATE_EXTRA3  //detailed debug
			#define SANI_DEBUG_PROPAGATE_EXTRA4
			#define SANI_DEBUG_PROPAGATE_EXTRA2
		#endif
		...
		#endif
		#ifndef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
			#define SANI_SEQUENCE_GRAMMAR_NEVER_SPLIT_GROUP_BETWEEN_TWO_IDENTICAL_COMPONENTS	//added SANI1j2bTEMP8-TEMP9, updated SANI1j2bTEMP14-TEMP16	//this prevents algorithm issues involving repeated sequenceElements (or sequences)
		#endif
		#ifndef SANI_SEQUENCE_GRAMMAR_NEVER_SPLIT_GROUP_BETWEEN_TWO_IDENTICAL_COMPONENTS
			//#define SANI_SEQUENCE_GRAMMAR_PREVENT_WRITE_IF_UPPER_NEURON_ALREADY_CONTAINS_SEQUENCE_INDEX_OF_EXISTING_COMPONENT	//added SANI1j2aTEMP145, removed SANI1j2aTEMP8
		#endif
		...
		//#ifndef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2
			#define SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//CHECKTHIS
				...
				#ifdef SANI_SEQUENCE_GRAMMAR_COMPONENT_GENERATE_VARIABLE_FIRST_COMPONENTS
					#define SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_EFFICIENT	//SANI1n9a
					//#define SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_HISTORY	//disabled SANI1o1a (CHECKTHIS)
					#ifndef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
		...
		#define SANI_SEQUENCE_GRAMMAR_GROUP_TYPE_DEFAULT_NAME "sequenceGrammarAutoGeneratedGroups"
		...
		//#define SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET	//depreciated @SANI1m3c //generates preliminary (non-functional) representation of sequence grammer network exclusively using ANNneuronClass rather than SANInodesGroupClass:ANNneuronClass
			...
			/*
				...
				#define SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET_VIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE
					...
					#define LRP_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE_RAW	//this is an adaption of LRP_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE to output entire sentence POS rather than that centred on a particular sequenceElement
			...
			*/
			...
			#ifdef COMPILE_LRP_GENERATE_POS_TAGGER_DATABASE	//ie LRP_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE
				//execute SANIgenerateCompact directly/immediately on wikidump POS tag derivations
				//assume compiled with COMPILE_LRP_WITH_ANN_GENERATE_POS_TAGGER_DATABASE
		...
		#define SANI_COMPACT
			...
			#define SANI_RESET_COMPONENT_NEURON_COMPONENT_CONNECTION_ACTIVE_SEQUENCEELEMENT_RECORD
			
			#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY
			#ifdef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY
				//#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//made optional for SANI_SEQUENCE_GRAMMAR_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT_AFTER_SIMULTANEOUS_POS_PROPAGATION @SANI1p7a (defined above)
				#ifdef SANI_SEQUENCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFICATION
					#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC
			...
			#define SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY	//SANI1h2a	//assume cannot backprop through parseTreeGroupNeuralNet
				...
				#ifndef SANI_SEQUENCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFICATION
		...
		//#ifdef SANI_PARSE	//not yet defined
			...
			//#ifdef SANI_LIGHT_OPTIMISED	//not yet defined
				...
				#define SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY	//SANI1h2a	//assume cannot backprop through parseTreeGroupNeuralNet
					...
					#endif
					#ifdef SANI_BIO_WEAK1
						#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT_MUTUALLY_EXCLUSIVE_BIO	//SANI1i1a
					#endif
					//not yet coded;
				...
				#define SANI_PARSE_SIMULTANEOUS	//SANI1i1a	//optional	//equivalent to old <SANI1g1i !SANI_PARSE_SEPARATE
					...
					#define SANI_PARSE_SIMULTANEOUS_DELETE_INCOMPLETE_PATHS_SEMANTIC_RELATIONS	//SANI1i1a
						...
						#define SANI_PARSE_RECORD_COMPONENT_SEQUENCE_INDEX
					#endif
...
//#define SANI_DEBUG_DISABLE_1h_CODE
				...
				//#ifdef GIA_NEURAL_NETWORK_SYMBOLIC_CORE	//not yet defined;
					...
					#define GIA_NEURAL_NETWORK_SYMBOLIC_CORE_SEPARATE_INSTANCES_BY_SENTENCE_INDEX	//SANI1h4b //do not use z dimension to display net
						...
						//#define GIA_NEURAL_NETWORK_SYMBOLIC_CORE_SEPARATE_INSTANCES_BY_SENTENCE_INDEX_SENTENCE_YPOS_OFFSET (10)	//~= max number of sequenceElements per sentence/2	//now is dynamic
					#endif
				...
				#define SANI_ANN_GROUP_SPACING_X (1)
					...
					#define SANI_ANN_GROUP_SPACING_Y (10)
				#else
...
//#define SANI_DEBUG_DISABLE_1g_CODE
	...
	#define SANI_COMPONENT_INDEX_FIRST (0)	//3g6a
	...
	#ifdef SANI_FORWARD	
		#ifndef SANI_COMPACT
			//SANI GIA compatible algorithm selection:
		...
		#define SANI_SEQUENCE_INDEX_W_TO_ENTITY_INDEX_OFFSET (1)	//w starts at 0, sentence entityIndex starts at 1
		...
		#ifndef SANI_POS_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START_DISABLE	//added SANI1m1a
			//SANI1g1aTEMP47	//SANI_PARSE does not currently robustly support SANI_POS_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START
			#ifdef SANI_FORWARD
				#define SANI_POS_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START		//assume mandatory (definately required for SANI_PARSE_PERFORMANCE_RECORD_PERFORMANCE)
			#else
				#define SANI_POS_REL_TRANSLATOR_RULES_ITERATE_OVER_UNAMBIGUOUS_POS_PERMUTATIONS_AT_START		//disabling this is not supported due to optional components (but ideally this should be disabled to increase performance)
			#endif
		#endif
				...
				//#define SANI_DEBUG_PARSE_TREE_PRINT_SUPPORT_RECURSION	//disabled 1p7a
				...
				#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY	//SANI1g8aTEMP51
				...
				//#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT_OLD	//why was this never defined?
				...
				#define SANI_REMOVE_LAST_OPTIONAL_COMPONENTS	//optional: significantly simplifies algorithm
					...
					#define SANI_SUPPORT_FUZZY_LAST_COMPONENTS
						...
						#define SANI_SUPPORT_FUZZY_LAST_COMPONENTS_METHOD2	//SANI1g6aTEMP54	//requires SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT
				...
				#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY
				#ifdef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY
					#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//SANI1g6aTEMP55	//make sure there is adjacent sequenceElement connectivity between previous active components and newly activated component - ie no sequenceElement indices are skipped
					#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_SEQUENCEELEMENT	//SANI1g6bTEMP4
					#ifdef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_SEQUENCEELEMENT
						#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_SEQUENCEELEMENT_NOUNS_ONLY
						#ifndef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_SEQUENCEELEMENT_NOUNS_ONLY
							#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_VERIFY_HYPOTHETICAL_PROPOGATION_FINDS_PREVIOUS_SEQUENCEELEMENT_MULTIPLE_ACTIVATION_HYPOTHESES	//can perform pass through through multiple unactivated groups
						#endif
					#endif
					#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BASIC	//SANI1g1x		
					#ifdef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BASIC
						//#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BASIC_MAX_1_CONSECUTIVE_ISOLATED_WORDS	//SANI1g1x	//reactivated SANI1g6aTEMP58
						//#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BASIC_CONSECUTIVE_WORDS_SAME_POSTYPE	//SANI1g6aTEMP58
					#endif
					#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC	//SANI1g1b
				#endif 
			#endif
			#ifdef SANI_HEAVY
				...
				#define SANI_RESET_COMPONENT_NEURON_COMPONENT_CONNECTION_ACTIVE_SEQUENCEELEMENT_RECORD	//SANI1g11aTEMP46
				...
				#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY
				#ifdef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY
					#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC	//CHECKTHIS
					#ifdef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC
						#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT	//CHECKTHIS
						#ifdef SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT
							#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_POSTHOC_STRICT_MUTUALLY_EXCLUSIVE	//SANI1g11g
						#endif
					#endif
					#define SANI_ENFORCE_SEQUENCEELEMENT_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//CHECKTHIS
				#endif

				#define SANI_LIGHT_NEW_CODE	//new code specific to SANI_LIGHT encapsulated for reference only
				...
				#define SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT	//mandatory
					...
					#define SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_WORD		//rely on existingActivationFoundStartComponent instead
						...
						#define SANI_LIGHT_OPTIMISED_RESET_ONLY_ONCE_FOUND_FIRST_COMPONENT_RESET_ONCE_PER_SEQUENCEELEMENT_BASIC	//SANI1g11aTEMP44
						//#endif
					#endif
				#endif
			#endif
				...
				#define SANI_LIGHT_NEW_CODE	//new code specific to SANI_LIGHT encapsulated for reference only
					...
					#define SANI_LIGHT_MEM
						...
						//perform restore of neuron activations based on their associated sequenceElement index rather than local memory
