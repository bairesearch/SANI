...
//#define GIA_DEBUG_DISABLE_1l_CODE
	...
	//#endif
		...
		//#ifdef SANI_SEQUENCE_GRAMMAR_SUPPORT_PARTIAL_SENTENCE_PROPAGATION	//not yet defined
			//#ifdef SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE	//not yet defined (generation code implementation has not yet been derived for ELONGATED_TREE)
					...
					#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS	//SANI1l6b	
						...
						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_GENERATE_DETECT_COVERAGE_SUPPORT_VARIABLE_END_COMPONENT	//SANI1l7c

                				#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_REMEMBER_FIRST_COMPONENT_WORD_INDEX	//SANI1l7a	//see SANI_ALLOW_MULTIPLE_ACTIVATIONS
						...
						//replications of conditions defined in SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS;

						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS

						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_NON_STRING

						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_PREFERENCE_THEM	//this preferences merging existing groups over creating new groups 
						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_DISABLE_MULTIPLE_INPUTS_IF_HAS_IDENTICAL_COMPONENTS

						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE
							...
							#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE
							#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE_MIN_NEURONS (2)
						#endif

						#ifndef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE
							#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_MATCHING_DEPTH	//SANI1l6c
							#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE_MATCHING_DEPTH
								#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS_X_COMP_REQUIRE_MATCHING_DEPTH
								#define SANI_SEQUENCE_GRAMMAR_RECORD_DEPTH
								#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENTS_LAST_COMP_REQUIRE
							#endif
						#endif
						...
						//#ifdef SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//not yet defined
							...
							//#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_LAST_COMPONENT_ALL_NEURONS_IN_FIRST_COMPONENT_SUBGROUPS_ARE_UNIQUE
		...
		//#endif
			...
			//#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS	//not yet defined
				#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS

				#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_NON_STRING

				//#ifndef SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_VARIABLE	//not yet defined
					#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_SIMPLIFIED	//SANI1l6a	//check dependency on findAndReconcileIncrementalVariationLimitNumComponentsSection (vs findAndReconcileIncrementalVariation)
				//#endif
				...
				//#ifdef SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE	//not yet defined
					...
					#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_SIZEABLE_SUBTREE	//SANI1l5a
					#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_SIZEABLE_SUBTREE
						#define SANI_SEQUENCE_GRAMMAR_RECORD_DEPTH
						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE
						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_SIZEABLE_SUBTREE_MIN_NEURONS (2)
						#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_NON_STRING
							#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_NON_STRING_COMPREHENSIVE
						#endif
					#endif
				//#endif
			//#endif
	...
	//#define SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_ACTIVATION	//SANI1l1b	//for visualisation - ensure to sync ANNglobalDefs.hpp: ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_ACTIVE
	...
	#define SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_COMPONENT_INDEX	//SANI1l1a	//for visualisation/debugging - ensure to sync ANNglobalDefs.hpp: ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_COMPONENT_ORDER
...
//#define GIA_DEBUG_DISABLE_1k_CODE
	...
	#ifdef USE_NLC
		#define GIA_PREPROCESSOR_POS_TYPE_CROSS_REFERENCE_STANFORD_POS_ARRAY_LIMITED	//SANI1l3a	//restores GIApreprocessorPOStypeCrossReferenceStanfordPos to original state
	#endif
		...
		*/
		...
		//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_SIMPLIFY	//SANI1k8a - untested: consider enabling in the future
		
		//#define SANI_SEQUENCE_GRAMMAR_PREVENT_RESET_IF_FIRST_INACTIVE_COMPONENT_GROUPREF_IS_SAME_AS_FUTURE_ACTIVE_COMPONENT_GROUPREF_AND_SATISIFIES_WORD_INDEX	//SANI1k4a, disabled SANI1k7a
		...
		//#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS
			#define SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_ONLY_SUPPORT_MISSING	//SANI1k14d
			#ifdef SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_ONLY_SUPPORT_MISSING
				#define SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_MISSING	//temporarily disable for debug only
				//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_VARIABLE
			#else
				#define SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_MISSING	//mandatory
				#define SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_VARIABLE	//mandatory	
			#endif
			/*
			NOTUSED:
			#ifdef SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_MISSING
				#define SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_MISSING_OR_VARIABLE
			#endif
		...
		//#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS	//SANI1k1a
			...
			#define SANI_SEQUENCE_GRAMMAR_VERIFY_NO_CIRCULAR	//used for debugging (circular loops don't get generated by !SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS, or are generated much less often)
				...
				#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS	//SANI1k1b
				#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS
										
					#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_PREVENT_DUPLICATE_CONNECTIONS	//SANI1k14e
					...
					//#ifdef SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//not yet defined
						...
						//#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENT_ALL_NEURONS_IN_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE		//SANI1k12a trial only
						#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_SIZEABLE_SUBTREE
						...
						#endif
						#ifdef SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_BASIC	//not yet defined
					...
					#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_PREFERENCE_THEM	//SANI1k3a	//this preferences merging existing groups over creating new groups 

					//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS_PRELIM_TEST	//SANI1k3a+	//not yet complete - requires definition of function copyRuleGroupType
					
					#ifndef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_SIZEABLE_SUBTREE
						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_FIRST_COMP_REQUIRE_MATCHING_DEPTH	//SANI1k3a
					...
					#ifdef SANI_SEQUENCE_GRAMMAR_ADD_NEW_NEURONS_TO_SYMMETRICAL_TREE
						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE	//SANI1k3a
					#endif
					#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE
						#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_LAST_COMP_REQUIRE_SIZEABLE_SUBTREE_MIN_NEURONS (2)
					#endif
						
					#ifndef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_COMPONENTS_X_COMP_REQUIRE_MATCHING_DEPTH
						//#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_PRUNE	//SANI1k6+
						#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_PRUNE
							#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_OPTIONAL	//replicate pathway generation without supporting variable first components
						#endif
						//#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_RANDOMISE	//SANI1k3a
						#ifdef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_RANDOMISE
							#define SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENTS_RANDOMISE_PROB (0.5)	//probability of accepting variable 1st component (ie merge)
						#endif
					#endif
				...
				//#ifdef SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//not yet defined
					#define SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_EFFICIENT	//SANI1k12a
					#ifndef SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_EFFICIENT
						#define SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_BASIC	//disabled SANI1k12a
...
//#define GIA_DEBUG_DISABLE_1j_CODE
	...
	//#define SANI_SEQUENCE_GRAMMAR	//SANI1j2a
		...
		#endif
		#ifndef SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS
		...
		//#ifndef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS_2
			#define SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING	//CHECKTHIS
				...
				#ifdef SANI_SEQUENCE_GRAMMAR_COMPONENT_SUPPORT_VARIABLE_FIRST_COMPONENTS
					#define SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_BASIC
					#ifdef SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_BASIC
						#define SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_HISTORY
					#endif
					#ifndef SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
		...
		//#define SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_INPUT_DATASET	//generates preliminary (non-functional) representation of sequence grammer network exclusively using ANNneuronClass rather than SANInodesGroupClass:ANNneuronClass
				...
				#define SANI_SEQUENCE_GRAMMAR_PRELIMTEST_GENERATE_CLASSIFICATION_NET_ANN_DATAFILE_NAME "POStaggerOutputClassificationNetExperiencesDataFile.dat"
					...
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_USE_ANN	//SANI1j2a
			...
			//final version (non testing) 
				...
				#define GIA_PREPROCESSOR_POS_TAGGER_GENERATE_NEURAL_NETWORK_SEQUENCE_GRAMMAR		
					...
					//#ifdef GIA_PREPROCESSOR_POS_TAGGER_DATABASE_FEED_ALL_PERMUTATIONS_INDIVIDUALLY_ONLY_TRAIN_UNAMBIGUOUS_PERMUTATIONS	//not yet defined	//recommended/required for train efficiency	//CHECKTHIS is compatible with GIA_PREPROCESSOR_POS_TAGGER_GENERATE_NEURAL_NETWORK_SEQUENCE_GRAMMAR
						//#define GIA_PREPROCESSOR_POS_TAGGER_GENERATE_NEURAL_NETWORK_SEQUENCE_GRAMMAR_ONLY_TRAIN_UNAMBIGUOUS_PERMUTATIONS	//disabled SANI1k7a		
					//#endif
		...
		#endif
		//#define SANI_SEQUENCE_GRAMMAR_MAX_NUMBER_LAYERS (200)	//adjust //~=GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE_RAW_SENTENCE_MAX_NUM_WORDS
		...
		#define GIA_PREPROCESSOR_POS_TAGGER_SEQUENCE	//sentence subset
			...
			//#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_TRAIN_AMBIGUOUS_PERMUTATIONS	//disabled SANI1k7a
		#endif
	#else
		#define COMPILE_GIA_GENERATE_POS_TAGGER_DATABASE_ORIG
		#ifdef COMPILE_GIA_GENERATE_POS_TAGGER_DATABASE_ORIG
			#define GIA_PREPROCESSOR_POS_TAGGER_SENTENCE	//SANI1j6c	//enable for POStagSentence (else POStagSequence) database generation	//optional
			#ifndef GIA_PREPROCESSOR_POS_TAGGER_SENTENCE
				#define GIA_PREPROCESSOR_POS_TAGGER_SEQUENCE	//sentence subset
				#ifdef GIA_PREPROCESSOR_POS_TAGGER_SEQUENCE
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_TRAIN_AMBIGUOUS_PERMUTATIONS	//clarification def added SANI1j6a
				#endif
			#endif
...
//#define GIA_DEBUG_DISABLE_1g_CODE
	...
	#else
		#define GIA_POS_REL_TRANSLATOR_INVERSE_NEURAL_NETWORK	//SANI1f
	#endif
#endif
