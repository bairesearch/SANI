...
//#define SANI_DEBUG_DISABLE_1n_CODE
	...
	//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_GENERATE_VARIABLE_COMPONENTS	//SANI1j-1m (generates variable first/last components when generating network)
		...
		#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_ONE_PER_SENTENCE	//SANI1n4a
		...
		#define SANI_SEQUENCE_GRAMMAR_RECORD_NEWLY_GENERATED_NEURONS		//store newly created sentence neurons in newHiddenLayerGroupsTemp
			...
			#define SANI_SEQUENCE_GRAMMAR_RECORD_NEWLY_GENERATED_NEURONSB	//mark all neurons in newHiddenLayerGroupsTemp
		...
		#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_DETECTED_EDGE_OF_SENTENCE	//SANI1n1a
			...
			#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_FIRST_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENT_ALL_NEURONS_IN_FIRST_COMPONENT_SUBGROUPS_ARE_UNIQUE
			//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_FIRST_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENT_ALL_NEURONS_IN_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE
			...
			#endif
			#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_DISABLE_MULTIPLE_INPUTS_IF_HAS_IDENTICAL_COMPONENTS
			//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_LAST_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENT_ALL_NEURONS_IN_FIRST_COMPONENT_SUBGROUPS_ARE_UNIQUE
			//#define SANI_SEQUENCE_GRAMMAR_COMPONENT_IDENTIFY_VARIABLE_COMPONENTS_LAST_COMPONENTS_SUPPORT_VARIABLE_FIRST_COMPONENT_ALL_NEURONS_IN_LAST_COMPONENT_SUBGROUPS_ARE_UNIQUE		
		#endif
	#endif
