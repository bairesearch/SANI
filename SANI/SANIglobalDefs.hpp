...
//#define SANI_DEBUG_DISABLE_1q_CODE
				...
				//#define SANI_SEQUENCE_GRAMMAR_VARIABLE_COMPONENTS_OVERLOAD	//SANI1q1a - do not assign a top level neuron for every sentence (words/POS)
...
//#define SANI_DEBUG_DISABLE_1p_CODE
		...
		//#endif
			...
			#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS	//SANI1p9a	//requires SANI_SEQUENCE_GRAMMAR_DETERMINE_POS_AMIGUITY_INFO_AT_START
				...
				#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_MARK_AS_UNAMBIGUOUS	//SANI1p9a 	//mark ambiguous inputs as unambigous if they are successfully parsed by an unambiguous/unique POS input
					...
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_MARK_AS_UNAMBIGUOUS_VERIFY_POS_UNAMBIGUOUS_WORDS	//SANI1p9a -  pos ambiguous components nodes are resolved when they are parsed with a non-ambiguous word
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_MARK_AS_UNAMBIGUOUS_VERIFY_UNIQUE	//SANI1p9a - pos ambiguous components nodes are resolved when 1 pos value is possible by the component based on the sentence word pos values	//optional
				#endif
				#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED	//SANI1p10a	- allow pos ambiguous input subsentences to be matched to existing subnets
					...
					#endif
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_VERIFY 	//SANI1p10a	//pos ambiguous input sentence words can only be matched to pos unambiguous subnet/unique POS input
					...
					#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_REQUIRE_POS_UNAMBIGUOUS_CONTEXT
						...
						#define SANI_SEQUENCE_GRAMMAR_INPUT_POS_AMBIGUOUS_PERMUTATIONS_ALLOW_TO_BE_MATCHED_REQUIRE_POS_UNAMBIGUOUS_CONTEXT_BOUNDARY (2)	//pos ambiguous [consecutive?] words must be bounded x pos unambiguous words	
					...
					#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION
						...
						#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_VIA_DETERMINERS	//SANI1p1a - perform SANI reference set identification via new method	//requires further testing
							...
							#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE
								...
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_WORDS_CAPTURED_USE	//neurons with components containing words in order and contiguous are preferred
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_SIGNAL_COMPONENTS_WORDS_SEQUENTIALITY_USE	//neurons with components containing words in order and contiguous are preferred
								...
								#define SANI_SEQUENCE_GRAMMAR_REFERENCE_SET_IDENTIFICATION_PROPAGATE_ACTIVATION_INPUT_SIGNAL (1.0)	//input signal of each word is set to 1.0
		...
		//#ifndef SANI_SEQUENCE_GRAMMAR_ENFORCE_WORD_CONNECTIVITY_POSTHOC_STRICT_AFTER_SIMULTANEOUS_POS_PROPAGATION
...
//#define SANI_DEBUG_DISABLE_1m_CODE
	...
	//#define SANI_SEMANTIC_NETWORK	//SANI1m1a	//store semantic network within SANI parse tree rather than generating from SANI parse tree
		...
		#define SANI_SEQUENCE_GRAMMAR_INPUT_WORDS	//SANI1m1a	//input words rather than pos values into SANI
			...
			#define SANI_SEQUENCE_GRAMMAR_INPUT_DYNAMIC	//explicated SANI1p9a	//dynamically generate input neurons based on content (words)
		...
		*/
		...
		#define SANI_COMPACT
			...
			#define SANI_ENFORCE_WORD_CONNECTIVITY
				...
				//#define SANI_ENFORCE_WORD_CONNECTIVITY_BETWEEN_PREVIOUS_ACTIVE_COMPONENTS_AND_NEWLY_ACTIVATED_COMPONENT	//made optional for SANI_SEQUENCE_GRAMMAR_ENFORCE_WORD_CONNECTIVITY_POSTHOC_STRICT_AFTER_SIMULTANEOUS_POS_PROPAGATION @SANI1p7a (defined above)
				#ifdef SANI_SEQUENCE_WORDCONNECTIVITY_VERIFICATION
					#define SANI_ENFORCE_WORD_CONNECTIVITY_POSTHOC
		...
		//#ifdef SANI_PARSE	//not yet defined
			...
			//#ifdef SANI_LIGHT_OPTIMISED	//not yet defined
				...
				#define SANI_BIO_DO_NOT_RELY_ON_PARSE_TREE_MEMORY	//SANI1h2a	//assume cannot backprop through parseTreeGroupNeuralNet
					...
					#endif
					#ifdef SANI_BIO_WEAK1
						#define SANI_ENFORCE_WORD_CONNECTIVITY_POSTHOC_STRICT_MUTUALLY_EXCLUSIVE_BIO	//SANI1i1a
					#endif
					//not yet coded;
				...
				#define SANI_PARSE_SIMULTANEOUS	//SANI1i1a	//optional	//equivalent to old <SANI1g1i !SANI_PARSE_SEPARATE
					...
					#define SANI_PARSE_SIMULTANEOUS_DELETE_INCOMPLETE_PATHS_SEMANTIC_RELATIONS	//SANI1i1a
						...
						#define SANI_PARSE_RECORD_COMPONENT_WORD_INDEX
					#endif
		...
		#define SANI_PARSE	//SANI1g1c
			...
			//#define SANI_HEAVY	//SANI1g6-9
				...
				#define SANI_HEAVY_OPTIMISED	//SANI1g8-9
					...
					//#define SANI_ENFORCE_WORD_CONNECTIVITY_POSTHOC_STRICT_OLD	//why was this never defined?
					...
					#define SANI_ENFORCE_WORD_CONNECTIVITY
						...
						#endif
						#define SANI_ENFORCE_WORD_CONNECTIVITY_POSTHOC	//SANI1g1b
					#endif 
				#endif
				...
				//light: only ever maintain a single instance of the neural network in memory
					...
					#define SANI_LIGHT_OPTIMISED		//SANI1g11a
						...
						#define SANI_ENFORCE_WORD_CONNECTIVITY
						#ifdef SANI_ENFORCE_WORD_CONNECTIVITY
							#define SANI_ENFORCE_WORD_CONNECTIVITY_POSTHOC	//CHECKTHIS
							#ifdef SANI_ENFORCE_WORD_CONNECTIVITY_POSTHOC
								#define SANI_ENFORCE_WORD_CONNECTIVITY_POSTHOC_STRICT	//CHECKTHIS
								#ifdef SANI_ENFORCE_WORD_CONNECTIVITY_POSTHOC_STRICT
									#define SANI_ENFORCE_WORD_CONNECTIVITY_POSTHOC_STRICT_MUTUALLY_EXCLUSIVE	//SANI1g11g
								#endif
							#endif
