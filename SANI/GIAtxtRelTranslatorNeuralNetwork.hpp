...
class GIAtxtRelTranslatorNeuralNetworkClass
{
					...
					private: bool propagateWordThroughNetworkGroupSelect(GIAtranslatorVariablesClass* translatorVariables, GIAtxtRelTranslatorRulesGroup* group, GIAtxtRelTranslatorNeuralNetworkForwardPropogationSignalData* forwardPropogationSignalData, GIAtxtRelTranslatorNeuralNetworkForwardPropogationWordData* forwardPropogationWordData, GIAtxtRelTranslatorNeuralNetworkForwardPropogationSentenceData* forwardPropogationSentenceData, int layer, const bool measureActivationRecencyOnly, const bool measureActivationRecencyOnlyFirstBifurcation, vector<GIAactivationPathMostRecentContribution>* frontLayerActivationPathMostRecentContribution, GIAtxtRelTranslatorRulesGroup* activationPathWordCurrentParseTreeGroup, const bool passThrough);
						...
						private: bool propagateWordThroughNetworkGroupComponentWrapper(GIAtranslatorVariablesClass* translatorVariables, GIAtxtRelTranslatorRulesGroup* group, GIAtxtRelTranslatorRulesComponent* currentComponent, GIAtxtRelTranslatorRulesGroup* ownerGroup, GIAtxtRelTranslatorRulesComponent* ownerComponent, GIAtxtRelTranslatorNeuralNetworkForwardPropogationSignalData* forwardPropogationSignalData, GIAtxtRelTranslatorNeuralNetworkForwardPropogationWordData* forwardPropogationWordData, GIAtxtRelTranslatorNeuralNetworkForwardPropogationSentenceData* forwardPropogationSentenceData, int layer, const bool measureSequentialActivationOnly, const bool measureActivationRecencyOnly, bool* frontLayerActivationPathMostRecentContributionRequireResetGroupActivation, GIAtxtRelTranslatorRulesGroup* activationPathWordCurrentParseTreeGroup);	
							...
							private: bool propagateWordThroughNetworkGroupVerifyComponentSequenceActivationReady(GIAtxtRelTranslatorRulesGroup* group, GIAtxtRelTranslatorRulesComponent* currentComponent, GIAtxtRelTranslatorRulesGroup* ownerGroup, GIAtxtRelTranslatorRulesComponent* ownerComponent, GIAtxtRelTranslatorRulesGroup* activationPathWordCurrentParseTreeGroup, vector<GIAtxtRelTranslatorRulesComponent*>* components, GIAtxtRelTranslatorNeuralNetworkForwardPropogationWordData* forwardPropogationWordData, bool* activationSequenceCompleted, const bool frontLayerActivationPathMostRecentContributionRequireResetGroupActivation, bool* repeatDetected, int layer);
								private: bool propagateWordThroughNetworkGroupVerifyComponentSequenceActivationReadyBasic(GIAtxtRelTranslatorRulesComponent* testComponent, vector<GIAtxtRelTranslatorRulesComponent*>* components, GIAtxtRelTranslatorRulesGroup* ownerGroup, GIAtxtRelTranslatorNeuralNetworkForwardPropogationWordData* forwardPropogationWordData, bool* activationSequenceCompleted, const bool frontLayerActivationPathMostRecentContributionRequireResetGroupActivation, int* mostRecentContributionWordIndex, int layer);
									#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_ENFORCE_WORD_CONNECTIVITY_TEST_FULL_PARSE_TREES
									private: bool getMostRecentContributionWordIndexInParseTree(GIAtxtRelTranslatorRulesGroup* parseTreeGroup, int* mostRecentContributionWordIndexCurrent, int level);
									#endif
								private: bool propagateWordThroughNetworkGroupVerifyComponentSequenceActivationReadyOr(GIAtxtRelTranslatorRulesComponent* testComponent, vector<GIAtxtRelTranslatorRulesComponent*>* components, const bool frontLayerActivationPathMostRecentContributionRequireResetGroupActivation);
								private: bool propagateWordThroughNetworkGroupVerifyComponentSequenceActivationReadyRepeat(GIAtxtRelTranslatorRulesComponent* testComponent, vector<GIAtxtRelTranslatorRulesComponent*>* components, GIAtxtRelTranslatorNeuralNetworkForwardPropogationWordData* forwardPropogationWordData, const bool frontLayerActivationPathMostRecentContributionRequireResetGroupActivation, bool* repeatDetected);
	...
	private: bool getCurrentActivationValues(GIAtxtRelTranslatorRulesGroup* group, GIAtxtRelTranslatorRulesGroup** activationStackParseTreeGroup);
	private: bool setCurrentActivationValues(GIAtxtRelTranslatorRulesGroup* group, GIAtxtRelTranslatorRulesGroup* activationStackParseTreeGroup);
	#endif
	...
	private: bool solidifyNeuralNetBackpropGroupCurrentActiveComponent(GIAtxtRelTranslatorRulesGroup* group);
	#endif
	...
	private: bool measurePerformance(GIAtxtRelTranslatorRulesGroup* group, GIAtxtRelTranslatorNeuralNetworkForwardPropogationSentenceData* forwardPropogationSentenceData, int level);
	...
	bool laterComponentContainsWordReferencesFromEarlierComponents(GIAtxtRelTranslatorRulesGroup* group, GIAtxtRelTranslatorRulesComponent* currentComponent, GIAtxtRelTranslatorRulesGroup* ownerGroup, GIAtxtRelTranslatorRulesComponent* ownerComponent, GIAtxtRelTranslatorNeuralNetworkForwardPropogationWordData* forwardPropogationWordData, GIAtxtRelTranslatorRulesGroup* activationPathWordCurrentParseTreeGroup, int level, bool print);
		#ifdef GIA_TXT_REL_TRANSLATOR_NEURAL_NETWORK_SAVE_PARSE_TREE_REVERSE_REFERENCES
		bool laterComponentContainsWordReferencesFromHigherLevelParseTreeComponents(GIAtxtRelTranslatorRulesComponent* higherParseTreeComponent, GIAtxtRelTranslatorRulesComponent* newParseTreeComponent, int level, bool print, bool firstLevel);
		#endif
			bool laterComponentContainsWordReferencesFromEarlierComponent(GIAtxtRelTranslatorRulesComponent* earlierParseTreeComponent, GIAtxtRelTranslatorRulesComponent* newParseTreeComponent, int level, bool print);
				bool laterComponentRecursedHasWordReferenceFromEarlierComponent(GIAtxtRelTranslatorRulesComponent* earlierParseTreeComponent, GIAtxtRelTranslatorRulesComponent* newParseTreeComponentRecursed, int level, bool print);
					bool laterComponentRecursedHasWordReferenceFromEqualierComponentRecursed(GIAtxtRelTranslatorRulesComponent* earlierParseTreeComponentRecursed, GIAtxtRelTranslatorRulesComponent* newParseTreeComponentRecursed, int level, bool print);
	#endif
