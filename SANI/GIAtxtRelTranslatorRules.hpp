...
#define GIA_TXT_REL_TRANSLATOR_RULES_SEMANTIC_RELATION_conditionTo 38
	...
	#define GIA_TXT_REL_TRANSLATOR_RULES_TAG_groups ((string)"groups")
		#define GIA_TXT_REL_TRANSLATOR_RULES_GROUPS_TAG_groupType ((string)"groupType")
			...
			#define GIA_TXT_REL_TRANSLATOR_RULES_GROUPS_GROUPTYPE_TAG_group ((string)"group")	//NB X = groupType
				...
				#define GIA_TXT_REL_TRANSLATOR_RULES_GROUPS_GROUP_ATTRIBUTE_previousWordPOStype ((string)"previousWordPOStype")	//ensures that the previous referenceSet delimiter was preposition/verb before executing this group
...
class GIAtxtRelTranslatorRulesClass
{
	...
	public: bool extractGIAtxtRelTranslatorRulesGroups(vector<GIAtxtRelTranslatorRulesGroupType*>* GIAtxtRelTranslatorRulesGroupTypes);
		private: bool parseComponents(XMLparserTag* firstTxtRelTranslatorRulesFirstComponentTag, vector<GIAtxtRelTranslatorRulesComponent*>* componentsList, const bool parseSubcomponent);
	...
	public: bool printComponent(GIAtxtRelTranslatorRulesComponent* currentParseTreeComponent, int layer);
