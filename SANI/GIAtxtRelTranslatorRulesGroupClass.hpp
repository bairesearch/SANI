...
public:
	...
	#endif
	bool neuronTraced;
	bool neuronActive;	//interpretation: all components are active (unless they are optional / unused or cases)	//not used
...
public:
	...
	GIAtxtRelTranslatorRulesGroup* activationPathWordFirstParseTreeGroup;
