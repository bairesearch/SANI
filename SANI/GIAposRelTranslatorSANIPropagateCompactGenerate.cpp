...
bool GIAposRelTranslatorSANIPropagateCompactGenerateClass::executeTxtRelTranslatorNeuralNetwork(GIAtranslatorVariablesClass* translatorVariables, vector<GIAposRelTranslatorRulesGroupType*>* GIAposRelTranslatorRulesGroupTypes, vector<GIApreprocessorPlainTextWord*>* sentenceContents, GIAposRelTranslatorRulesGroupParseTree** topLevelParseTreeGroup, const bool parseIsolatedSubreferenceSets, const bool parserEnabled, int* performance, const bool createNewConnections)
{
	...
	{		
		//cout << "!toplevelGroupActivationFound" << endl;
	...
	{
		//cout << "GIAposRelTranslatorSANIPropagateCompactGenerateClass::toplevelGroupActivationFound!" << endl;
	}
	#endif
...
#endif
{
	...
	{	
		...
		{
			//cout << "recordActivatedNeuronWithMaxWordIndexCoverageSupportVariableStartComponent = true;" << endl;
		...
		*/	
		...
		//cout << "stillIdentifyingHighLevelNeurons = false" << endl;	
		...
		{			
			...
			/*
			cout << "completedIdentifyingSentenceHighLevelNeurons = true" << endl;	
			cout << " indexInSequence = " << indexInSequence << endl;
...
{	
	...
	*indexInSequence = calculateNextIndexInSequence(forwardPropogationSentenceData);
	//cout << "\n next indexInSequence = " << *indexInSequence << endl;
...
bool GIAposRelTranslatorSANIPropagateCompactGenerateClass::connectListOfHighLevelNeuronsToNewNeuronLimitNumComponentsSection(vector<GIAposRelTranslatorRulesGroupType*>* GIAposRelTranslatorRulesGroupTypes, GIAposRelTranslatorSANIForwardPropogationSentenceData* forwardPropogationSentenceData, vector<GIAposRelTranslatorRulesGroupNeuralNetwork*>* listOfHighLevelNeurons, GIAposRelTranslatorRulesGroupNeuralNetwork** grammaticalSentenceNeuron, const bool createTopLevelNeuron, const bool completedIdentifyingSentenceHighLevelNeurons, int indexInSequenceStart, vector<GIAposRelTranslatorRulesGroupNeuralNetwork*>* highLevelNeuronPriorArray)
{
	...
	if(currentHighLevelNeuron->activatedNeuronWithMaxWordIndexCoverageVariableStartComponentTemp)
	{
		...
		//cout << "grammaticalSentenceNeuronSubHigher->networkDepth = " << grammaticalSentenceNeuronSubHigher->networkDepth << endl;
		#endif
...
bool GIAposRelTranslatorSANIPropagateCompactGenerateClass::connectListOfHighLevelNeuronsToNewNeuronLimitNumComponentsSection(vector<GIAposRelTranslatorRulesGroupType*>* GIAposRelTranslatorRulesGroupTypes, GIAposRelTranslatorSANIForwardPropogationSentenceData* forwardPropogationSentenceData, vector<GIAposRelTranslatorRulesGroupNeuralNetwork*>* listOfHighLevelNeurons, GIAposRelTranslatorRulesGroupNeuralNetwork** grammaticalSentenceNeuron, const bool createTopLevelNeuron, const bool completedIdentifyingSentenceHighLevelNeurons, int indexInSequenceStart, GIAposRelTranslatorRulesGroupNeuralNetwork** highLevelNeuronPrior)
{
	...
	if(indexInSequenceStart == 0)
	{
		...
		for(int k=0; k<listOfHighLevelNeurons->size(); k++)
		{
			...
			//cout << "grammaticalSentenceNeuronSub->networkDepth = " << grammaticalSentenceNeuronSub->networkDepth << endl;
			#endif
		}	
	}
	else
	...
	//cout << "grammaticalSentenceNeuronSub->components.size() = " << grammaticalSentenceNeuronSub->components.size() << endl;
	#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_LIMIT_NUM_COMPONENTS
...
bool GIAposRelTranslatorSANIPropagateCompactGenerateClass::createOrAppendFirstLevelHiddenLayerGroup(vector<GIAposRelTranslatorRulesGroupType*>* GIAposRelTranslatorRulesGroupTypes, GIAposRelTranslatorSANIForwardPropogationSentenceData* forwardPropogationSentenceData, GIAposRelTranslatorRulesGroupNeuralNetwork* currentLayerNeuronGroupStart, bool* creatingNewNeuronSequence, int* neuronSequenceIndex, GIAposRelTranslatorRulesGroupNeuralNetwork** newNeuronSequenceGroup, vector<GIAposRelTranslatorRulesGroupNeuralNetwork*>* listOfHighLevelNeurons)
{
	...
	else
	{
		...
		*creatingNewNeuronSequence = true;
		...
		//OLD:
		#ifdef GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_PREVENT_INTRASENTENCE_MATCHING_BASIC
		//irrelevant requirement all sublayer neurons are POS inputs/strings and will not be added to listOfHighLevelNeuronsCompleteHistory anyway
...
int GIAposRelTranslatorSANIPropagateCompactGenerateClass::calculateNextIndexInSequence(GIAposRelTranslatorSANIForwardPropogationSentenceData* forwardPropogationSentenceData)
{
	...
	if(forwardPropogationSentenceData->parseSentenceReverse)
	{
		//cout << "\n**** forwardPropogationSentenceData->activatedNeuronWithMaxWordIndexCoverage->parseTreeMinWordIndex = " << forwardPropogationSentenceData->activatedNeuronWithMaxWordIndexCoverage->parseTreeMinWordIndex << endl;
...
bool GIAposRelTranslatorSANIPropagateCompactGenerateClass::updateHighLevelNeuronHierachy(vector<GIAposRelTranslatorRulesGroupType*>* GIAposRelTranslatorRulesGroupTypes, GIAposRelTranslatorSANIForwardPropogationSentenceData* forwardPropogationSentenceData, vector<GIAposRelTranslatorRulesGroupNeuralNetwork*>* highLevelNeuronPriorArray, int lowestLayerNeuronIndex, GIAposRelTranslatorRulesGroupNeuralNetwork* grammaticalSentenceNeuronSub, const bool completedIdentifyingSentenceHighLevelNeurons)
{
	...
	while(!foundHigherLevelWithoutNeuronNeuronPrior)
	{
		if((i < highLevelNeuronPriorArray->size()) && ((*highLevelNeuronPriorArray)[i] != NULL))
		{
			...
			#ifdef GIA_DEBUG_POS_REL_TRANSLATOR_SANI_FORMATION
			//cout << "GIAposRelTranslatorSANIPropagateCompactGenerateClass::updateHighLevelNeuronHierachy" << endl;
			#endif
